...
function ver_carta($texto,$id_client,$x) {
	...
	if ($x == 1){
		...
		$texto = str_replace("[AdreÁa]",$row["direccion"], $texto);
...
#La funciÛn principal se llama "convertir_a_letras($numero)". Admite un rango desde "0.01" hasta "999999999.99" (incluyendo los dos decimales).
function centimos() {
...
function unidad_centimos($numero) {
	switch ($numero) { 
		case 9: { $num_letra = "nueve cÈntimos"; break; }
		case 8: { $num_letra = "ocho cÈntimos"; break; }
		case 7: { $num_letra = "siete cÈntimos"; break; }
		case 6: { $num_letra = "seis cÈntimos"; break; }
		case 5: { $num_letra = "cinco cÈntimos"; break; }
		case 4: { $num_letra = "cuatro cÈntimos"; break; }
		case 3: { $num_letra = "tres cÈntimos"; break; }
		case 2: { $num_letra = "dos cÈntimos"; break; }
		case 1: { $num_letra = "un cÈntimo"; break; }
	}
	return $num_letra;
}
...
function decena_centimos($numero) {
	if ($numero >= 10) {
		if ($numero >= 90 && $numero <= 99) {
			if ($numero == 90) return "noventa cÈntimos";
			else if ($numero == 91) return "noventa y un cÈntimos";
		else
			return "noventa y ".unidad_centimos($numero - 90);
		}
		if ($numero >= 80 && $numero <= 89) {
			if ($numero == 80) return "ochenta cÈntimos";
			else if ($numero == 81) return "ochenta y un cÈntimos";
		else
			return "ochenta y ".unidad_centimos($numero - 80);
		}
		if ($numero >= 70 && $numero <= 79) { 
			if ($numero == 70) return "setenta cÈntimos";
			else if ($numero == 71) return "setenta y un cÈntimos";
		else
			return "setenta y ".unidad_centimos($numero - 70);
		}
		if ($numero >= 60 && $numero <= 69) {
			if ($numero == 60) return "sesenta cÈntimos";
			else if ($numero == 61) return "sesenta y un cÈntimos";
		else
			return "sesenta y ".unidad_centimos($numero - 60);
		}
		if ($numero >= 50 && $numero <= 59) {
			if ($numero == 50) return "cincuenta cÈntimos";
			else if ($numero == 51) return "cincuenta y un cÈntimos";
		else
			return "cincuenta y ".unidad_centimos($numero - 50);
		}
		if ($numero >= 40 && $numero <= 49) {
			if ($numero == 40) return "cuarenta cÈntimos";
			else if ($numero == 41) return "cuarenta y un cÈntimos";
		else
			return "cuarenta y ".unidad_centimos($numero - 40);
		}
		if ($numero >= 30 && $numero <= 39) {
			if ($numero == 30) return "treinta cÈntimos";
			else if ($numero == 91) return "treinta y un cÈntimos";
		else
			return "treinta y ".unidad_centimos($numero - 30);
		}
		if ($numero >= 20 && $numero <= 29) {
			if ($numero == 20) return "veinte cÈntimos";
			else if ($numero == 21) return "veintiun cÈntimos";
		else
			return "veinti".unidad_centimos($numero - 20);
		}
		if ($numero >= 10 && $numero <= 19) {
			if ($numero == 10) return "diez cÈntimos";
			else if ($numero == 11) return "once cÈntimos";
			else if ($numero == 12) return "doce cÈntimos";
			else if ($numero == 13) return "trece cÈntimos";
			else if ($numero == 14) return "catorce cÈntimos";
			else if ($numero == 15) return "quince cÈntimos";
			else if ($numero == 16) return "dieciseis cÈntimos";
			else if ($numero == 17) return "diecisiete cÈntimos";
			else if ($numero == 18) return "dieciocho cÈntimos";
			else if ($numero == 19) return "diecinueve cÈntimos";
		}
	}
	else
...
{
if ($numero == 0.01)
$num_letras = "un cÈntimo";
else
$num_letras = convertir_a_letras(($numero * 100)."/100")." cÈntimos";
}
}
return $num_letras;
}
