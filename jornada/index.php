			...
			echo "<td>";
				echo "<table class=\"banner\">";
					echo "<tr class=\"banner\">";
						echo "<td><img src=\"images/inici_".$idioma.".jpg\" alt=\"logo\"></td>";
					echo "</tr>";
				echo "</table>";
			echo "</td>";
		echo "</tr>";
					...
					echo "<tr>";
						echo "<td class=\"footer\">";
							echo "<table class=\"footer\" cellspacing=\"15px\">";
								echo "<tr><td class=\"footer2\"><a href=\"index.php?mn=0\" class=\"footer\"><strong>".$Programa."</strong></a></td>";
								echo "<td class=\"footer2\"><a href=\"index.php?mn=10\" class=\"footer\"><strong>".$Inscripcion."</strong></a></td>";
