...
ALTER TABLE `sgm_comercial_oferta` ADD `numero` int(11) NOT NULL default '0' AFTER `id_client`;
ALTER TABLE `sgm_comercial_oferta` ADD `version` int(11) NOT NULL default '0' AFTER `numero`;
ALTER TABLE `sgm_comercial_oferta` ADD `data` datetime NOT NULL default '0000-00-00 00:00' AFTER `version`;
