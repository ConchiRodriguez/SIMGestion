...
ALTER TABLE `sim_clientes` ADD `num_treballadors` int(11) NOT NULL default '0' AFTER `vencimiento`;
ALTER TABLE `sim_clientes` ADD `notas` longtext AFTER `num_treballadors`;
...
ALTER TABLE `sim_clientes` ADD `id_medio_facturacion` int(11) NOT NULL default '0' AFTER `vencimiento`;
ALTER TABLE `sim_clientes` ADD `destino_facturacion` varchar(255) NOT NULL default '' AFTER `id_medio_facturacion`;
ALTER TABLE `sim_clientes` ADD `id_formato_facturacion` int(11) NOT NULL default '0' AFTER `destino_facturacion`;
ALTER TABLE `sim_clientes` ADD `id_contacto_facturacion` int(11) NOT NULL default '0' AFTER `id_formato_facturacion`;
ALTER TABLE `sim_clientes` ADD `notas_facturacion` longtext AFTER `id_contacto_facturacion`;
...
ALTER TABLE `sim_clientes_contactos` ADD `nombre` varchar(255) NOT NULL default '' AFTER `visible`;
ALTER TABLE `sim_clientes_contactos` ADD `apellido1` varchar(255) NOT NULL default '' AFTER `nombre`;
ALTER TABLE `sim_clientes_contactos` ADD `apellido2` varchar(255) NOT NULL default '' AFTER `apellido1`;
ALTER TABLE `sim_clientes_contactos` ADD `cargo` varchar(255) NOT NULL default '' AFTER `apellido2`;
...
ALTER TABLE `sim_clientes_contactos` ADD `movil` varchar(15) NOT NULL default '' AFTER `mail`;
ALTER TABLE `sim_clientes_contactos` ADD `id_trato` int(11) NOT NULL default '0' AFTER `movil`;
ALTER TABLE `sim_clientes_contactos` ADD `id_idioma` int(11) NOT NULL default '0' AFTER `id_trato`;
ALTER TABLE `sim_clientes_contactos` ADD `notas` longtext AFTER `id_idioma`;
ALTER TABLE `sim_clientes_contactos` ADD `pred` tinyint(1) NOT NULL default '0' AFTER `notas`;
...
CREATE TABLE `sim_clientes_dias_vencimiento` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
ALTER TABLE `sim_clientes_dias_vencimiento` ADD `dia` int(11) NOT NULL default '0' AFTER `id`;
ALTER TABLE `sim_clientes_dias_vencimiento` ADD `id_cliente` int(11) NOT NULL default '0' AFTER `dia`;
...
INSERT INTO `sim_clientes_tratos` VALUES (1,'Sr.',1,1);
