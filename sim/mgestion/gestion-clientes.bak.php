...
if (($option == 1008) AND ($autorizado == true)) {
	...
	echo "<table style=\" border-bottom : 1px solid grey; border-left : 1px solid grey; border-right : 1px solid grey; border-top : 1px solid grey;text-align:center;width:100%\" cellpadding=\"2\" cellspacing=\"2\" ><tr>";
		echo "<tr><td>";
			echo "<center><table><tr>";
				echo "<td style=\"height:20px;width:120px;\";><strong>Contactos 2.1 :</strong></td>";
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black\"><a href=\"index.php?op=1008&sop=0\" class=\"gris\" style=\"color: white\">Buscar</a></td>";
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black\"><a href=\"index.php?op=1008&sop=0&id_classificacio=0\" class=\"gris\" style=\"color: white\">Ver Todos</a></td>";
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black\"><a href=\"index.php?op=1008&sop=2\" class=\"gris\" style=\"color: white\">Ver Todos Personales</a></td>";
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black\"><a href=\"index.php?op=1008&sop=210&id=0\" class=\"gris\" style=\"color: white\">Añadir Contacto</a></td>";
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black\"><a href=\"index.php?op=1008&sop=300\" class=\"gris\" style=\"color: white\">Indicadores</a></td>";
				...
				while ($rowt = mysql_fetch_array($resultt)){
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color: ".$rowt["color"].";color: white;border: 1px solid black\"><a href=\"index.php?op=1008&sop=0&id_classificacio=".$rowt["id"]."\" class=\"gris\" style=\"color: ".$rowt["color_lletra"]."\">".$rowt["nom"]."</a></td>";
				}
				echo "</tr></table>";
				if ($id_origen != 0) {
					echo "<table><tr>";
	...
	if ($soption == 0) {
		if ($_GET["id_classificacio"] == "") {
			echo "<form action=\"index.php?op=1008&sop=0\" method=\"post\">";
			echo "<center>";
						echo "<table cellspacing=\"0\">";
							echo "<tr style=\"background-color:silver;\">";
								echo "<td><strong>Buscar Contacto</strong></td>";
								echo "<td>Tipo</td>";
								echo "<td>Grupo</td>";
								echo "<td>Sector</td>";
							...
							echo "<tr>";
								echo "<td>";
									echo "<select name=\"id_classificacio\" style=\"width:175px\">";
							...
							echo "</tr>";
							echo "<tr style=\"background-color:silver;\">";
								echo "<td>Listar contactos</td>";
								echo "<td>Servicio</td>";
								echo "<td>Estado del Servicio</td>";
									...
									echo "<select name=\"contactes\" style=\"width:175px\">";
										echo "<option value=\"0\">NO</option>";
											...
											if ($_POST["contactes"] == 2) {
												echo "<option value=\"2\" selected>Solo predeterminado</option>";
											} else {
												echo "<option value=\"2\">Solo predeterminado</option>";
											}
										echo "</select>";
								echo "</td>";
								echo "<td>";
							...
							echo "<tr style=\"background-color:silver;\">";
								echo "<td></td>";
								echo "<td>Certificación</td>";
								echo "<td>Estado de la Certificación</td>";
								echo "<td></td>";
								echo "<td></td>";
							echo "</tr><tr>";
								echo "<td></td>";
			...
			echo "<br>";
						echo "<table cellpadding=\"0\" cellspacing=\"1\"><tr>";
								...
								echo "<td style=\"color:black;text-align: right;\"><strong>Apellido 1</strong></td>";
								echo "<td style=\"color:black;text-align: leftt;width:160px\"><input type=\"Text\" name=\"likeapellido1\" value=\"".$_POST["likeapellido1"]."\" style=\"width:150px\"></td>";
								echo "<td style=\"color:black;text-align: right;\"><strong>Apellido 2</strong></td>";
								echo "<td style=\"color:black;text-align: leftt;width:160px\"><input type=\"Text\" name=\"likeapellido2\" value=\"".$_POST["likeapellido2"]."\" style=\"width:150px\"></td>";
						echo "</tr></table>";
						...
						echo "<table cellpadding=\"0\" cellspacing=\"1\">";
							...
							echo "</tr>";
							echo "<tr>";
								echo "<td style=\"color:black;text-align: right;\"><strong>Inicial Nombre</strong></td>";
								for ($i = 0; $i <= 127; $i++) {
									if ((($i >= 48) and ($i <= 57)) or(($i >= 65) and ($i <= 90))) {
							...
							echo "</tr>";
							echo "<tr>";
								echo "<td style=\"color:black;text-align: right;\"><strong>Inicial Apellido 1</strong></td>";
								for ($i = 0; $i <= 127; $i++) {
									if ((($i >= 48) and ($i <= 57)) or(($i >= 65) and ($i <= 90))) {
										echo "<td style=\"color:black;text-align: center;\"><input type=\"Checkbox\" name=\"1".chr($i)."\"";
										if ($_POST["1".chr($i)] == true) { echo " checked"; }
										echo " value=\"true\" style=\"border:0px\"></td>";
									}
								}
							echo "</tr>";
							echo "<tr>";
								echo "<td style=\"color:black;text-align: right;\"><strong>Inicial Apellido 2</strong></td>";
								for ($i = 0; $i <= 127; $i++) {
									if ((($i >= 48) and ($i <= 57)) or(($i >= 65) and ($i <= 90))) {
										echo "<td style=\"color:black;text-align: center;\"><input type=\"Checkbox\" name=\"2".chr($i)."\"";
										if ($_POST["2".chr($i)] == true) { echo " checked"; }
										echo " value=\"true\" style=\"border:0px\"></td>";
									}
								}
							echo "</tr>";
		...
		if ($_GET["id_classificacio"] == "") {
			echo "<table>";
				...
				echo "<tr><td style=\"text-align:center;\"><input type=\"Submit\" value=\"Imprimir Lista\" style=\"width:100px\"></td></tr>";
			echo "</table>";
		}
		...
		for ($i = 0; $i <= 127; $i++) {
			if ((($i >= 48) and ($i <= 57)) or (($i >= 65) and ($i <= 90))) {
				...
				if (($_POST["likenombre"] != "") or ($_POST["likeapellido1"] != "") or ($_POST["likeapellido2"] != "")) {
					$sql = $sql." and (";
					if ($_POST["likenombre"] != "") { $sql = $sql."nombre like '%".$_POST["likenombre"]."%'"; }
					if ($_POST["likeapellido1"] != "") { 
						if ($_POST["likenombre"] != "") { $sql = $sql." or "; }
						$sql = $sql."cognom1 like '%".$_POST["likeapellido1"]."%'";
					}
					if ($_POST["likeapellido2"] != "") {
						if (($_POST["likenombre"] != "") or ($_POST["likeapellido1"] != "")) { $sql = $sql." or "; }
						$sql = $sql."cognom2 like '%".$_POST["likeapellido2"]."%'";
					}
					$sql = $sql.")";
				}
					...
					if ($ver == true) {
						if ($linea_letra == 1) {
							echo "<tr style=\"background-color: Silver;\">";
								...
								if ($calidad == true) {
									echo "<td></td>";
									echo "<td><em>Valoración</em></td>";
								}
							echo "</tr>";
							$linea_letra = 0;
						}
						ver_contacto($row["id"],$color,$calidad,$_POST["contactes"]);
			...
			echo "</table>";
			echo "<strong>Resultado de la busqueda: ".$z."</strong>";
			echo "</center>";
			echo "<br><br>";
			echo "<img src=\"mgestion/pics/icons-mini/page_white_error.png\" border=\"0\"> - Datos fiscales incompletos o NIF/CIF/NIE incorrectos";
			echo "&nbsp;&nbsp;<strong>Fid.</strong> - Cliente fidelizado.";
			echo "&nbsp;&nbsp;<strong>Vip</strong> - Cliente vip.";
			echo "<img src=\"mgestion/pics/icons-mini/building_add.png\" border=\"0\"> - Con delegaciones asociadas.";
			echo "<br>";
			echo "&nbsp;&nbsp;<img src=\"mgestion/pics/icons-mini/email_link.png\" border=\"0\"> - E-mail.";
			echo "&nbsp;&nbsp;<img src=\"mgestion/pics/icons-mini/page_white_link.png\" border=\"0\"> - Web.";
			echo "&nbsp;&nbsp;<img src=\"mgestion/pics/icons-mini/page_white_magnify.png\" border=\"0\"> - Información.";
			echo "&nbsp;&nbsp;<img src=\"mgestion/pics/icons-mini/page_white_text.png\" border=\"0\"> - Datos Fiscales.";
			echo "&nbsp;&nbsp;<img src=\"mgestion/pics/icons-mini/creditcards.png\" border=\"0\"> - Datos Administrativos.";
			echo "<img src=\"mgestion/pics/icons-mini/page_white_star.png\" border=\"0\"> - Gestión Comercial.";
			echo "<br>";
			...
			if ($calidad == true) {
				echo "&nbsp;&nbsp;<img src=\"mgestion/pics/icons-mini/page_white_gear.png\" border=\"0\"> - Controles de calidad.";
			}
		}
	}
		...
		$rowxt = mysql_fetch_array($resultxt);
			if ($rowxt["total"] > 0) {
				echo "<tr style=\"background-color: Silver;\">";
					...
					echo "<td><center>Teléfono</center></td>";
...
#						echo "<td>".$rowt["carrec"]."</td>";
    ...
    if (($soption == 10) AND ($admin == true)) {
                ...
                echo "<table cellpadding=\"0\" cellspacing=\"0\">";
                        echo "<form action=\"index.php?op=1008&sop=10&ssop=2\" method=\"post\">";
                        echo "<tr style=\"background-color:silver\">";
                                echo "<td></td>";
                        ...
                        echo "<tr style=\"background-color : ".$color."\">";
                                ...
                                echo "</td>";
                                echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1008&sop=11&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                        echo "<form action=\"index.php?op=1008&sop=10&ssop=1&id=".$row["id"]."\" method=\"post\">";
        ...
        if (($soption == 30) AND ($admin == true)) {
                ...
                echo "<strong>Administración de Ubicaciones de Clientes :</strong>";
                echo "<br><br>";
				echo "<table><tr>";
						echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
							echo "<a href=\"index.php?op=1008&sop=500\" style=\"color:white;\">&laquo; Volver</a>";
                ...
                echo "<table cellpadding=\"0\" cellspacing=\"0\">";
                        ...
                        echo "<tr style=\"background-color:silver\">";
                                echo "<td></td>";
                                echo "<td><em>Eliminar</em></td>";
                                echo "<td style=\"text-align:center;\">Ubicación</td>";
                                echo "<td></td>";
                        echo "<tr><td>&nbsp;</td></tr>";
                        echo "<tr>";
                                echo "<td></td>";
        ...
        if (($soption == 40) AND ($admin == true)) {
                ...
                echo "<strong>Administración de Tratos de Clientes :</strong>";
                echo "<br><br>";
				echo "<table><tr>";
						echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
							echo "<a href=\"index.php?op=1008&sop=500\" style=\"color:white;\">&laquo; Volver</a>";
        ...
        if (($soption == 50)) {
                ...
                echo "<strong>Administración de Tipos de Clientes :</strong>";
                echo "<br><br>";
				echo "<table><tr>";
						echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
							echo "<a href=\"index.php?op=1008&sop=500\" style=\"color:white;\">&laquo; Volver</a>";
        ...
        if (($soption == 60)) {
			echo "<strong>Administración de Definiciones :</strong>";
			echo "<br><br>";
			echo "<table><tr>";
				echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1008&sop=500\" style=\"color:white;\">&laquo; Volver</a>";
				...
				echo "<br><table cellpadding=\"1\" cellspacing=\"0\">";
					echo "<form action=\"index.php?op=1008&sop=60&ssop=1\" method=\"post\">";
                                echo "<tr style=\"background-color:silver\">";
                                        ...
                                        echo "<td><center><strong>Color Botón</strong></center></td>";
                                ...
                                echo "<tr>";
                                        ...
                                        echo "<td>";
                                                ...
                                                echo "</select>";
                                        echo "</td>";
                                        echo "<td>&nbsp;<input type=\"text\" style=\"width:140px\" name=\"nom\"></td>";
                                        echo "<td>&nbsp;<input type=\"text\" style=\"width:70px\" name=\"color\"></td>";
                                        echo "<td>&nbsp;<input type=\"text\" style=\"width:70px\" name=\"color_lletra\"></td>";
                        ...
                        while ($row = mysql_fetch_array($result)) {
                                echo "<tr>";
                                        ...
                                        echo "<td>";
                                                ...
                                                echo "</select>";
                                        echo "</td>";
                                        echo "<td>&nbsp;<input type=\"text\" value=\"".$row["nom"]."\" style=\"width:140px\" name=\"nom\"></td>";
                                        if ($row["id_origen"] == 0){
                                                echo "<td>&nbsp;<input type=\"text\" value=\"".$row["color"]."\" style=\"width:70px\" name=\"color\"></td>";
                                                echo "<td>&nbsp;<input type=\"text\" value=\"".$row["color_lletra"]."\" style=\"width:70px\" name=\"color_lletra\"></td>";
                                        } else {
                                                echo "<td></td>";
                                                echo "<td></td>";
                                        }
        ...
        if (($soption == 70) AND ($admin == true)) {
                ...
                if (($ssoption == 4) and ($admin == true)) {
						$sql = "insert into sgm_clients_certificaciones_docu (docu,id_certificado) ";
                        $sql = $sql."values (";
                        $sql = $sql."'".comillas($_POST["docu"])."'";
                        $sql = $sql.",'".$_GET["id_certificat"]."'";
                        $sql = $sql.")";
                        mysql_query(convert_sql($sql));
                }
                if (($ssoption == 5) and ($admin == true)) {
						$sql = "update sgm_clients_certificaciones_docu set ";
                        $sql = $sql."docu='".comillas($_POST["docu"])."'";
                        $sql = $sql." WHERE id=".$_GET["id"]."";
                        mysql_query(convert_sql($sql));
                }
                ...
                echo "<strong>Gestión de Certificaciones</strong>";
                echo "<br><br>";
				echo "<table><tr>";
						echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
							echo "<a href=\"index.php?op=1008&sop=500\" style=\"color:white;\">&laquo; Volver</a>";
                        ...
                        echo "<tr><td>&nbsp;</td></tr>";
                                ...
                                while ($row = mysql_fetch_array($result)) {
									echo "<tr style=\"background-color:silver;\">";
                                        ...
                                        echo "</form>";
        		                        echo "<td style=\"\"><em>Eliminar</em></td>";
    	        	                    echo "<td style=\"text-align:center;\">Documentos</td>";
	                	                echo "<td></td>";
									echo "</tr>";
									echo "<tr>";
										echo "<td></td>";
										...
										echo "<td></td>";
										echo "<td></td>";
										echo "<form action=\"index.php?op=1008&sop=70&ssop=4&id_certificat=".$row["id"]."\" method=\"post\">";
										echo "<td><input type=\"Text\" name=\"docu\" style=\"width:150px\"></td>";
										echo "<td><input type=\"Submit\" value=\"Añadir\" style=\"width:100px\"></td>";
										echo "<td></td>";
										echo "</form>";
									echo "</tr>";
									echo "<tr><td>&nbsp;</td></tr>";
                	                $sqlc = "select * from sgm_clients_certificaciones_docu where visible=1 and id_certificado=".$row["id"];
    	   	                        $resultc = mysql_query(convert_sql($sqlc));
	           	                    while ($rowc = mysql_fetch_array($resultc)) {
										echo "<tr>";
											echo "<td></td>";
											echo "<td></td>";
											echo "<td></td>";
											echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1008&sop=72&id=".$rowc["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
											echo "<form action=\"index.php?op=1008&sop=70&ssop=5&id=".$rowc["id"]."\" method=\"post\">";
											echo "<td><input type=\"Text\" name=\"docu\" style=\"width:150px\" value=\"".$rowc["docu"]."\"></td>";
											echo "<td><input type=\"Submit\" value=\"Modificar\" style=\"width:100px\"></td>";
											echo "<td></td>";
											echo "</form>";
										echo "</tr>";
        ...
        if (($soption == 72) and ($admin == true)) {
			echo "<center><br><br>¿Desea eliminar el documento del certificado?";
			echo "<br><br><a href=\"index.php?op=1008&sop=70&ssop=6&id=".$_GET["id"]."\">[ SI ]</a>";
			echo "&nbsp;<a href=\"index.php?op=1008&sop=70\">[ NO ]</a></center>";
        }
        ...
        if (($soption == 80) and ($admin == true)) {
                ...
                echo "<strong>Administrar Datos Adicionales</strong>";
                echo "<br><br>";
				echo "<table><tr>";
						echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
							echo "<a href=\"index.php?op=1008&sop=500\" style=\"color:white;\">&laquo; Volver</a>";
                ...
                echo "<center><table cellspacing=\"0\" style=\"width:300px\">";
                        ...
                        echo "<tr>";
                                ...
                                echo "<td><input style=\"width:100px\" type=\"Submit\" value=\"Añadir\"></td>";
                                echo "</form>";
                        echo "</tr>";
...
#					echo "<input type=\"Text\" name=\"dia_facturacion\" class=\"px150\">";
					...
					echo "</td></tr>";
					echo "<tr><td></td><td><input type=\"Submit\" value=\"Añadir\" style=\"width:300px\"></td></tr>";
			echo "</table>";
	...
	if ($soption == 102) {
		...
		echo "<table>";
			...
			echo "<tr>";
				...
				echo "<td><input type=\"submit\" value=\"Añadir\" style=\"width:75px\"></td>";
				echo "</form>";
			echo "</tr>";
		while ($row = mysql_fetch_array($result)) {
			echo "<tr>";
	...
	if (($soption >= 150) and ($soption <= 299) and  ($_GET[id] != 0) or ($soption == 550)) {
				...
				if (($total <= 0) and ($total1 <= 0)){
					...
					echo "<center><table cellspacing=\"0\" style=\"width:700px;height:70px;\">";
						echo "<tr style=\"background-color:red;\">";
							...
							echo "<br><center><a href=\"index.php?op=1008&sop=210&ssop=3&id=".$_GET["id"]."&id_clas=".$_POST["id_clasificacio_tipus"]."\" style=\"color:white;\">[ Añadir ]</a>";
							echo "&nbsp;&nbsp;&nbsp;<a href=\"index.php?op=1008&sop=210&ssop=4&id=".$_GET["id"]."&id_clas=".$_POST["id_clasificacio_tipus"]."\" style=\"color:white;\">[ Añadir y eliminar incompatibles]</a>";
							echo "&nbsp;&nbsp;&nbsp;<a href=\"index.php?op=1008&sop=210&id=".$_GET["id"]."\" style=\"color:white;\">[ No Añadir ]</a></center>";
						echo "</td></tr>";
					echo "</table></center>";
				}
			}
		...
		echo "<table cellpadding=\"0\">";
			echo "<tr>";
				echo "<td style=\"vertical-align:top\">";
					echo "<table cellpadding=\"0\">";
						echo "<tr><td style=\"width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 30px;\"><a href=\"index.php?op=1008&sop=210&id=".$row["id"]."\" style=\"color:white;\">Datos fiscales/generales</a></td></tr>";
						echo "<tr><td style=\"width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 30px;\"><a href=\"index.php?op=1008&sop=220&id=".$row["id"]."\" style=\"color:white;\">Datos administrativos</a></td></tr>";
				...
				echo "<td style=\"vertical-align:top\">";
					echo "<table cellpadding=\"0\">";
						echo "<tr><td style=\"width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 30px;\"><a href=\"index.php?op=1008&sop=240&id=".$row["id"]."\" style=\"color:white;\">Gestión comercial</a></td></tr>";
						echo "<tr><td style=\"width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 30px;\"><a href=\"index.php?op=1008&sop=270&id=".$row["id"]."\" style=\"color:white;\">Datos Técnicos</a></td></tr>";
				...
				echo "<td style=\"vertical-align:top\">";
					echo "<table cellpadding=\"0\">";
						...
						echo "<tr><td style=\"width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 30px;\"><a href=\"index.php?op=1008&sop=280&ssop=0&id=".$row["id"]."\" style=\"color:white;\">Histórico</a></td></tr>";
					echo "</table>";
				echo "</td>";
				...
				echo "<td style=\"vertical-align:top\">";
					echo "<table cellpadding=\"0\">";
						...
						echo "<tr><td style=\"width:120px;text-align:center;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 30px;\"><a href=\"index.php?op=1008&sop=295&id=".$row["id"]."\" style=\"color:white;\">Agrupación de Contactos</a></td></tr>";
					echo "</table>";
				echo "</td>";
        ...
        if (($soption == 140) AND ($admin == true)) {
                ...
                echo "<table cellpadding=\"1\" cellspacing=\"0\">";
                        echo "<form action=\"index.php?op=1008&sop=140&ssop=1&id_clas=".$_GET["id_clas"]."\" method=\"post\">";
                                echo "<tr style=\"background-color:silver\">";
                                        echo "<td><em>Eliminar</em></td>";
                                        echo "<td><center><strong>Incomptible</strong></center></td>";
                                        echo "<td></td>";
                                echo "</tr>";
                                echo "<tr>";
                                        echo "<td></td>";
	...
	if ($soption == 160) {
		...
		while ($row = mysql_fetch_array($result)) {
			...
			while ($rowf = mysql_fetch_array($resultf)) {
				if ($poner_cabezera == 1) {
					echo "<tr style=\"background-color:silver;\"><td style=\"width:100px;text-align:right;\">Número</td><td style=\"width:100px;text-align:right;\">Fecha</td><td style=\"width:100px;text-align:right;\">Importe</td><td style=\"width:100px;text-align:center;\">Cobrada</td><td style=\"width:100px;text-align:center;\">Cerrada</td><td style=\"width:100px;text-align:center;\">Confirmada</td><td style=\"width:100px;text-align:center;\">Confirmada Cliente</td></tr>";
					$poner_cabezera = 0;
				}
			...
			echo "<td>";
				echo "<table style=\"width:300px;\">";
					...
					if ($row["id_ubicacion"] != 0){
						...
						echo "<tr><td style=\"text-align:right;\">Ubicación :</td><td style=\"text-align:left;\"><strong>".$rowu["ubicacion"]."</strong></td></tr>";
					}
					echo "<tr><td style=\"text-align:right;\">Num. Trabajadores :</td><td style=\"text-align:left;\"><strong>".$row["num_treballadors"]."</strong></td></tr>";
				echo "</table>";
			echo "</td><td style=\"vertical-align:top;\">";
				echo "<table style=\"width:300px;\">";
					...
					if ($rowce["total"] != 0){
					echo "<tr><td style=\"vertical-align:top;text-align:right;\">Certificaciones :</td><td style=\"text-align:right;\">";
						echo "<table>";
							...
							while ($rowc= mysql_fetch_array($resultc)){
								...
								while ($rowcer= mysql_fetch_array($resultcer)){
									...
									echo "<tr><td style=\"text-align:left;\"><strong>".$rowcer["nombre"]."</strong></td><td style=\"text-align:right;\">".$rowcert["nombre"]."</td></tr>";
								}
							}
							echo "</td></tr>";
						echo "</table>";
	...
	if ($soption == 210) {
		...
		echo "<table><tr>";
			echo "<td style=\"vertical-align:top;\">";
				...
				echo "<table style=\"background-color : Silver;\">";
					echo "<tr><td style=\"text-align:right;width:100px\">Nombre: </td><td><input type=\"Text\" name=\"nombre\" value=\"".$row["nombre"]."\" class=\"px300\"></td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">Apellido 1: </td>";
						echo "<td style=\"text-align:left;\">";
							echo "<table cellspacing=\"0\"><tr><td><input type=\"Text\" name=\"cognom1\" value=\"".$row["cognom1"]."\" class=\"px120\"></td>";
							echo "<td style=\"text-align:right;width:60px\">Apellido 2: </td>";
							echo "<td><input type=\"Text\" name=\"cognom2\" value=\"".$row["cognom2"]."\" class=\"px115\"></td></tr></table>";
						echo "</td>";
					echo "</tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">NIF: </td><td><input type=\"Text\" name=\"nif\" value=\"".$row["nif"]."\" class=\"px300\"></td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px;vertical-align:top;\">Dirección: </td><td><textarea name=\"direccion\" class=\"px300\" rows=\"3\">".$row["direccion"]."</textarea></td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">Código Postal: </td><td><input type=\"Text\" name=\"cp\" value=\"".$row["cp"]."\" class=\"px300\"></td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">Población: </td><td><input type=\"Text\" name=\"poblacion\" value=\"".$row["poblacion"]."\" class=\"px300\"></td></tr>";
				...
				echo "</table>";
				echo "<table>";
					echo "<tr><td style=\"text-align:right;width:100px\">Pais: </td><td>";
					...
					echo "</td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">E-mail</td><td><input type=\"Text\" name=\"mail\" class=\"px300\" value=\"".$row["mail"]."\"></td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">Web</td><td><input type=\"Text\" name=\"web\" class=\"px300\" value=\"".$row["web"]."\"></td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">Teléfono</td><td>";
						echo "<table cellspacing=\"0\">";
							echo "<tr><td><input type=\"Text\" name=\"telefono\" class=\"px120\" value=\"".$row["telefono"]."\"></td>";
							echo "<td style=\"text-align:right;width:55px\">Teléfono 2</td><td><input type=\"Text\" name=\"telefono2\" class=\"px120\" value=\"".$row["telefono2"]."\"></td></tr>";
						echo "</table>";
					echo "</td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">Fax</td><td>";
						echo "<table cellspacing=\"0\">";
							echo "<tr><td><input type=\"Text\" name=\"fax\" class=\"px120\" value=\"".$row["fax"]."\"></td>";
							echo "<td style=\"text-align:right;width:55px\">Fax 2</td><td><input type=\"Text\" name=\"fax2\" class=\"px120\" value=\"".$row["fax2"]."\"></td></tr>";
						echo "</table>";
					echo "</td></tr>";
			...
			echo "<td style=\"vertical-align:top\">";
				echo "<table>";
					...
					echo "<tr><td style=\"text-align:right;width:100px\">Delegación central</td><td>";
						...
						echo "</select>";
					echo "<tr><td style=\"text-align:right;width:100px\">Contacto principal</td><td>";
			...
			echo "<tr>";
				echo "<td></td>";
				echo "<td><strong>Definición de cliente</strong></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td></td>";
				echo "<td>";
			...
			while ($rowcl = mysql_fetch_array($resultcl)) {
				...
				while ($rowcla = mysql_fetch_array($resultcla)) {
					echo "<tr>";
						echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1008&sop=216&id_class=".$rowcla["id"]."&id=".$_GET["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
						echo "<td>".$rowcla["nom"]."</td>";
							echo "</tr>";
						}
					}

					echo "<tr><td style=\"text-align:right;width:100px\">Cliente Fidelizado</td><td>";
						if ($row["client"] == 1) {
					...
					echo "</td></tr>";
					echo "<tr><td style=\"text-align:right;width:100px\">Cliente VIP</td><td>";
						if ($row["clientvip"] == 1) {
					...
					echo "<tr><td style=\"text-align:right;width:100px\">Ubicación</td><td><select style=\"width:300px;\" name=\"id_ubicacion\">";
						echo "<option value=\"0\">Indeterminado</option>";
		...
		echo "<center><table>";
			echo "<tr>";
				...
				echo "<td><textarea name=\"notas\" style=\"width:615px\" rows=\"2\">".$row["notas"]."</textarea></td>";
				echo "<td style=\"width:200px\"></td>";
			echo "</tr>";
		echo "</table>";
		echo "</center>";
		if ($_GET["id"] > 0) { echo "<center><input type=\"Submit\" value=\"Guardar cambios\" style=\"width:300px\"></center>"; }
		if ($_GET["id"] == 0) {	echo "<center><input type=\"Submit\" value=\"Añadir\" style=\"width:300px\"></center>";	}
		echo "</form>";
	}

	if ($soption == 212) {
		$sql = "insert into sgm_clients (id_origen,id_agrupacio,nombre,cognom1,cognom2,nif,direccion,poblacion,cp,provincia,client,clientvip,sector,id_tipo,id_grupo,id_ubicacion,id_pais,id_idioma,mail,telefono,telefono2,fax,fax2,web,notas,general,servicio)";
		$sql = $sql."values (";
		$sql = $sql."".$_POST["id_origen"];
...
##		$sql = $sql.",".$_POST["id_tipo_cliente"];
##		$sql = $sql.",".$_POST["impacto"];
##		$sql = $sql.",".$_POST["id_tipo_impacto"];
##		$sql = $sql.",".$_POST["proveedor"];
##		$sql = $sql.",".$_POST["id_tipo_proveedor"];
				...
				echo "<td style=\"vertical-align:top;width:50%;text-align:center;\">";
					...
					echo "<table cellspacing=\"0\" style=\"width:325px\">";
						...
						echo "<tr>";
							...
							$selected = '';
							echo "<td>";
								echo "<select name=\"formas_pago\">";
									if ($row["formas_pago"] == "Cheque"){ $selected = 'Selected';} else { $selected = ''; }
										echo "<option value=\"Cheque\" ".$selected.">Cheque</option>";
									if ($row["formas_pago"] == "Pagaré"){ $selected = 'Selected';} else { $selected = ''; }
										echo "<option value=\"Pagaré\" ".$selected.">Pagaré</option>";
									if ($row["formas_pago"] == "Transferencia"){ $selected = 'Selected';} else { $selected = ''; }
										echo "<option value=\"Transferencia\" ".$selected.">Transferencia</option>";
									if ($row["formas_pago"] == "Efectivo"){ $selected = 'Selected';} else { $selected = ''; }
										echo "<option value=\"Efectivo\" ".$selected.">Efectivo</option>";
									if ($row["formas_pago"] == "Recibo"){ $selected = 'Selected';} else { $selected = ''; }
										echo "<option value=\"Recibo\" ".$selected.">Recibo</option>";
								echo "</select>";
							echo "</td>";
						echo "</tr>";
						echo "<tr>";
	...
	if ($soption == 221) {
		...
		$sql = $sql.",dias=".$_POST["dias"]."";
		$sql = $sql.",cuentacontable='".$_POST["cuentacontable"]."'";
		$sql = $sql.",formas_pago='".$_POST["formas_pago"]."'";
		$sql = $sql." WHERE id=".$_GET["id"]."";
		mysql_query(convert_sql($sql));
	...
	if ($soption == 240) {
		echo "<strong>Gestión Comercial :</strong>";
		echo "<center>";
			echo "<table>";
				...
				$rowt = mysql_fetch_array($resultt);
				echo "<tr>";
					echo "<form action=\"index.php?op=1008&sop=246&id=".$_GET["id"]."\" method=\"post\">";
		...
		echo "<form action=\"index.php?op=1023&sop=210\" method=\"post\">";
			...
			echo "</td>";
			echo "<td style=\"text-align:right;\"></td><td><input type=\"Submit\" value=\"Añadir\" style=\"width:80px;\"></td>";
		echo "</form>";
			...
			echo "<table cellspacing=\"0\">";
			echo "<tr style=\"background-color:silver;\">";
				echo "<td style=\"width:100px;text-align:center;\">Código</td>";
			...
			echo "<form action=\"index.php?op=1008&sop=241&id=".$_GET["id"]."\" method=\"post\">";
				...
				while ($row = mysql_fetch_array($result)) {
					...
					if ($row["titol"] == 1){
						echo "<tr>";
							echo "<td><input type=\"Text\" name=\"codigo\" style=\"width:100px\" value=\"".$row["codigo"]."\" disabled></td>";
							echo "<td><input type=\"Text\" name=\"codigo\" style=\"width:250px\" value=\"".$row["servicio"]."\" disabled></td>";
							echo "<td></td>";
							echo "<td></td>";
							echo "<td></td>";
							echo "<td></td>";
					...
					echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=2&id_cliente=".$_GET["id"]."&id_servicio=".$row["id"]."&usuario_destino=".$userid."\"><img src=\"mgestion/pics/icons-mini/page_white_go.png\" style=\"border:0px\"></a></td>";
				echo "</tr>";
				}
	...
	if ($soption == 241) {
		...
		while ($row = mysql_fetch_array($result)) {
			...
			$rowx = mysql_fetch_array($resultx);
			if ($rowx["total"] == 0) {
				$sql = "insert into sgm_incidencias_servicios_cliente (id_servicio,id_cliente,id_estado,id_proveedor,id_proveedor_caracteristica) ";
				$sql = $sql."values (";
				$sql = $sql."".$row["id"];
				$sql = $sql.",".$_GET["id"];
...
#			echo $sql."<br>";
		...
		echo "<center>";
		echo "<br><br>Operación realizada correctamente.";
		echo "<br><br><a href=\"index.php?op=1008&sop=240&id=".$_GET["id"]."\">[ Volver ]</a>";
		echo "</center>";
	}
	...
	if ($soption == 250) {
		...
		if ($ssoption == 2) {
			$sql = "insert into sgm_clients_certificaciones_docu_client (id_certificado,id_cliente,id_estado) ";
			$sql = $sql."values (";
			$sql = $sql."".$_POST["id_certificado"];
			$sql = $sql.",".$_GET["id"];
			$sql = $sql.",".$_POST["id_estado"];
			$sql = $sql.")";
			mysql_query(convert_sql($sql));
		...
		if ($ssoption == 3) {
			$sql = "update sgm_clients_certificaciones_docu_client set ";
			$sql = $sql."visible = 0";
			$sql = $sql." WHERE id =".$_GET["id_certificat"]."";
			mysql_query(convert_sql($sql));
		}
		if ($ssoption == 4) {
			$sql = "insert into sgm_clients_certificaciones_docu_client (id_certificado,id_cliente,id_docu) ";
			$sql = $sql."values (";
			$sql = $sql."".$_GET["id_certificat"];
			$sql = $sql.",".$_GET["id"];
			$sql = $sql.",".$_POST["id_docu"];
			$sql = $sql.")";
			mysql_query(convert_sql($sql));
		}
		if ($ssoption == 5) {
		...
		if ($ssoption == 7) {
			$sql = "insert into sgm_clients_material (id_cliente,id_material) ";
			$sql = $sql."values (";
			$sql = $sql."".$_GET["id"];
			$sql = $sql.",".$_POST["id_material"];
			$sql = $sql.")";
			mysql_query(convert_sql($sql));
		}
		if ($ssoption == 8) {
			$sql = "update sgm_clients_material set ";
			$sql = $sql."visible = 0";
			$sql = $sql." WHERE id =".$_GET["id_material"]."";
			mysql_query(convert_sql($sql));
		}

		echo "<table><tr><td style=\"vertical-align:top;\">";
		echo "<strong>Listado de Certificaciones del Contacto</strong><br><br>";
		echo "<center>";
		echo "<table cellspacing=\"0\">";
		echo "<tr style=\"background-color:silver;\">";
		...
		echo "<strong>Listado de Certificaciones Requeridas por el Contacto</strong><br><br>";
		echo "<center>";
		echo "<table cellspacing=\"0\">";
			echo "<tr style=\"background-color:silver;\">";
				echo "<td style=\"width:150px;text-align:center;\">Certificacion</td>";
				echo "<td style=\"width:150px;text-align:center;\">Estado</td>";
				echo "<td></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<form action=\"index.php?op=1008&sop=250&ssop=2&id=".$_GET["id"]."\" method=\"post\">";
				echo "<td><select name=\"id_certificado\" style=\"width:150px\">";
				$sql = "select * from sgm_clients_certificaciones where visible=1 order by nombre";
				$result = mysql_query(convert_sql($sql));
				while ($row = mysql_fetch_array($result)) {
					$sqlz = "select count(*) as total from sgm_clients_certificaciones_docu_client where visible=1 and id_certificado=".$row["id"]." and id_docu=0";
					$resultz = mysql_query(convert_sql($sqlz));
				...
				echo "</select></td>";
				echo "<td><select name=\"id_estado\" style=\"width:150px\">";
				echo "<option value=\"0\" selected>-</option>";
				$sql = "select * from sgm_clients_certificaciones_estados where visible=1 order by nombre";
				$result = mysql_query(convert_sql($sql));
				while ($row = mysql_fetch_array($result)) {
		...
		echo "<table cellspacing=\"0\">";
			echo "<tr style=\"background-color:silver;\">";
				...
				echo "<td></td>";
				echo "<td style=\"\"><em>Eliminar</em></td>";
				echo "<td style=\"width:150px;text-align:center;\">Documento</td>";
			echo "</tr>";
			echo "<tr>";
			$sqlc = "select * from sgm_clients_certificaciones_docu_client where visible=1 and id_cliente=".$_GET["id"]." and id_docu=0";
			$resultc = mysql_query(convert_sql($sqlc));
			while ($rowc = mysql_fetch_array($resultc)) {
				echo "<tr>";
					echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1008&sop=250&ssop=3&id_certificat=".$rowc["id"]."&id=".$_GET["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
					$sqlcd = "select * from sgm_clients_certificaciones where visible=1 and id=".$rowc["id_certificado"];
					$resultcd = mysql_query(convert_sql($sqlcd));
					$rowcd = mysql_fetch_array($resultcd);
					echo "<td>".$rowcd["nombre"]."</td>";
					echo "<form action=\"index.php?op=1008&sop=250&ssop=6&id=".$_GET["id"]."&id_certificat=".$rowc["id"]."\" method=\"post\">";
					echo "<td><select name=\"id_estado\" style=\"width:100px\">";
					echo "<option value=\"0\" selected>-</option>";
					$sql = "select * from sgm_clients_certificaciones_estados where visible=1 order by nombre";
					$result = mysql_query(convert_sql($sql));
					while ($row = mysql_fetch_array($result)) {
						if ($row["id"] == $rowc["id_estado"] ){
							echo "<option value=\"".$row["id"]."\" selected>".$row["nombre"]."</option>";
						} else {
							echo "<option value=\"".$row["id"]."\">".$row["nombre"]."</option>";
						}
					...
					echo "</select></td>";
					echo "<td><input type=\"Submit\" value=\"Modificar\" style=\"width:70px\"></td>";
					echo "</form>";
					echo "<td></td>";
					echo "<form action=\"index.php?op=1008&sop=250&ssop=4&id=".$_GET["id"]."&id_certificat=".$rowc["id"]."\" method=\"post\">";
					echo "<td><select name=\"id_docu\" style=\"width:150px\">";
					$sqlx = "select * from sgm_clients_certificaciones_docu where visible=1 and id_certificado=".$rowcd["id"];
					$resultx = mysql_query(convert_sql($sqlx));
					while ($rowx = mysql_fetch_array($resultx)) {
						$sqlxxx = "select count(*) as total from sgm_clients_certificaciones_docu_client where visible=1 and id_docu=".$rowx["id"];
						$resultxxx = mysql_query(convert_sql($sqlxxx));
						$rowxxx = mysql_fetch_array($resultxxx);
						if ($rowxxx["total"] == 0){
							echo "<option value=\"".$rowx["id"]."\">".$rowx["docu"]."</option>";
						}
					}
					echo "</select></td>";
					echo "<td><input type=\"Submit\" value=\"Añadir\" style=\"width:100px\"></td>";
					...
					echo "</form>";
				echo "</tr>";
				$sqlcc = "select * from sgm_clients_certificaciones_docu_client where visible=1 and id_certificado=".$rowc["id"]." and id_docu>0";
				...
				while ($rowcc = mysql_fetch_array($resultcc)) {
					echo "<tr>";
						...
						echo "<td></td>";
						echo "<td></td>";
						echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1008&sop=250&ssop=5&id_certificat=".$rowcc["id"]."&id=".$_GET["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
						$sqlxx = "select * from sgm_clients_certificaciones_docu where visible=1 and id=".$rowcc["id_docu"];
						$resultxx = mysql_query(convert_sql($sqlxx));
						$rowxx = mysql_fetch_array($resultxx);
						echo "<td>".$rowxx["docu"]."</td>";
						echo "<td></td>";
					echo "</tr>";
				}
			}
		...
		echo "<strong>Material Suministrado</strong><br><br>";
		echo "<center>";
		echo "<table cellspacing=\"0\">";
			echo "<tr style=\"background-color:silver;\">";
				echo "<td style=\"\"><em>Eliminar</em></td>";
				echo "<td style=\"width:150px;text-align:center;\">Material</td>";
				echo "<td></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td></td>";
				echo "<form action=\"index.php?op=1008&sop=250&ssop=7&id=".$_GET["id"]."\" method=\"post\">";
				echo "<td><select name=\"id_material\" style=\"width:150px\">";
				$sql = "select * from sgm_material where visible=1 order by material";
				$result = mysql_query(convert_sql($sql));
				while ($row = mysql_fetch_array($result)) {
					$sqlz = "select count(*) as total from sgm_clients_material where visible=1 and id_material=".$row["id"];
					$resultz = mysql_query(convert_sql($sqlz));
					$rowz = mysql_fetch_array($resultz);
					if ($rowz["total"] == 0){
						echo "<option value=\"".$row["id"]."\" selected>".$row["material"]."</option>";
					}
				}
				echo "</select></td>";
				echo "<td><input type=\"Submit\" value=\"Añadir\" style=\"width:100px\"></td>";
			...
			echo "<tr><td>&nbsp;</td></tr>";
			echo "<tr>";
			$sqlc = "select * from sgm_clients_material where visible=1 and id_cliente=".$_GET["id"];
			$resultc = mysql_query(convert_sql($sqlc));
			while ($rowc = mysql_fetch_array($resultc)) {
				echo "<tr>";
					echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1008&sop=250&ssop=8&id_material=".$rowc["id"]."&id=".$_GET["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
					$sqlcd = "select * from sgm_material where visible=1 and id=".$rowc["id_material"];
					$resultcd = mysql_query(convert_sql($sqlcd));
					$rowcd = mysql_fetch_array($resultcd);
					echo "<td>".$rowcd["material"]."</td>";
				echo "</tr>";
			}
		echo "</table>";
		echo "</center>";
	...
	if ($soption == 260) {
		...
		echo "<table><tr>";
			echo "<td style=\"width:130px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
				echo "<a href=\"index.php?op=1008&sop=261&ssop=1&id=".$_GET["id"]."\" style=\"color:white;\">Añadir nuevo contacto</a>";
			echo "</td>";
		echo "</tr></table>";
		echo "<br><br><center>";
		echo "<table cellspacing=\"0\">";
			echo "<tr style=\"background-color: Silver;\">";
				...
				echo "<td style=\"width:100px;text-align:center;\"><em>Teléfono</em></td>";
				echo "<td style=\"width:100px;text-align:center;\"><em>Móvil</em></td>";
	...
	if ($soption == 261) {
		...
		if ($ssoption == 1) { 
			echo "<strong>Añadir nuevo contacto</strong><br><br>";
		...
		echo "<table>";
			echo "<tr>";
				if ($ssoption == 1) { echo "<td>&nbsp;</td><td><input type=\"submit\" value=\"Añadir\" style=\"width:100px\"></td>"; }
...
#				<input type=\"text\" name=\"tracte\" style=\"width:200px\" value=\"".$rowc[$pre."tracte"]."\"></td>";
			...
			echo "</tr><tr>";
				echo "<td style=\"text-align:right;\">Teléfono: </td>";
			...
			echo "</tr><tr>";
				echo "<td style=\"text-align:right;\">e-Mail: </td>";
				echo "<td><input type=\"text\" name=\"mail\" style=\"width:200px\" value=\"".$rowc[$pre."mail"]."\"></td>";
			echo "</tr><tr>";
				echo "<td style=\"text-align:right;\">Móvil: </td>";
...
#			echo "</tr><tr>";
			echo "</tr><tr>";
			echo "</tr><tr>";
				echo "<td style=\"text-align:right;\">Secretario/a: </td>";
...
#		$sql = $sql.",contacto_id_idioma=".$_POST["id_idioma"]."";
	...
	if ($soption == 270) {
		...
		echo "<br><table cellpadding=\"1\" cellspacing=\"0\">";
			echo "<tr style=\"background-color : Silver;\">";
				echo "<td style=\"width:150px;\">Dato Adicional</td>";
				echo "<td></td>";
		...
		echo "<br><table>";
			echo "<tr style=\"background-color : Silver;\"><td style=\"width:800px\">DATOS ADIONALES</td></tr>";
...
#				echo "<td style=\"text-align:right;\"></td>";
			...
			echo "<tr style=\"background-color:silver;\">";
				echo "<td>Número</td>";
				echo "<td></td>";
				echo "<td style=\"text-align:right;\">Filtrado por:</td>";
				...
				echo "</select></td>";
				echo "<td>";
					echo "<input type=\"Submit\" value=\"Ver\" style=\"width:40px\">";
				echo "</td>";
				echo "<td></td>";
			echo "</tr>";
		echo "</form>";
...
#					} else {echo "<td></td>";}
	...
	if ($soption == 295) {
		echo "<strong>Agrupación de contactos : </strong><br>";
		...
		while ($rowc = mysql_fetch_array($resultc)) {
			...
			if ($row["id_agrupacio"] > 0) {
				if (($rowc["id_agrupacio"] == $row["id_agrupacio"]) and ($row["id"] != $rowc ["id"])) {
					...
					if ($rowc["provincia"] != "") {echo " (".$rowc["provincia"].")";}
					echo "<br>";
					if ($rowc["telefono"] != "") { echo "<br>Teléfono : <strong>".$rowc["telefono"]."</strong>"; }
	...
	if ($soption == 300) {
		...
		echo "<center>";
		echo "<table cellpadding=\"0\" cellspacing=\"0\">";
			echo "<tr style=\"background-color:silver\"><td style=\"text-align:center;width:150px\">Indicador</td><td style=\"text-align:center;width:150px\">Valor</td></tr>";
			...
			echo "<tr><td style=\"text-align:left\"><strong>Total contactos</strong></td><td style=\"text-align:center\"><strong>".$rowxt["total"]."</strong></td></tr>";
						...
						$sqlxt = "select count(*) as total from sgm_clients where visible=1 and cliente=1";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$rowxt = mysql_fetch_array($resultxt);
			echo "<tr><td style=\"text-align:left\">Total contactos clientes</td><td style=\"text-align:center\">".$rowxt["total"]."</td></tr>";

						$sqlxt = "select count(*) as total from sgm_clients where visible=1 and proveedor=1";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$rowxt = mysql_fetch_array($resultxt);
			echo "<tr><td style=\"text-align:left\">Total contactos provedores</td><td style=\"text-align:center\">".$rowxt["total"]."</td></tr>";

						$sqlxt = "select count(*) as total from sgm_clients where visible=1 and impacto=1";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$rowxt = mysql_fetch_array($resultxt);
			echo "<tr><td style=\"text-align:left\">Total contactos impactos</td><td style=\"text-align:center\">".$rowxt["total"]."</td></tr>";
			...
			echo "<tr><td style=\"text-align:left\"><strong>Total contactos (sin delegaciones)</strong></td><td style=\"text-align:center\"><strong>".$rowxt["total"]."</strong></td></tr>";
						...
						$sqlxt = "select count(*) as total from sgm_clients where visible=1 and cliente=1 and id_origen=0";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$rowxt = mysql_fetch_array($resultxt);
			echo "<tr><td style=\"text-align:left\">Total contactos clientes (sin delegaciones)</td><td style=\"text-align:center\">".$rowxt["total"]."</td></tr>";

						$sqlxt = "select count(*) as total from sgm_clients where visible=1 and proveedor=1 and id_origen=0";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$rowxt = mysql_fetch_array($resultxt);
			echo "<tr><td style=\"text-align:left\">Total contactos provedores (sin delegaciones)</td><td style=\"text-align:center\">".$rowxt["total"]."</td></tr>";

						$sqlxt = "select count(*) as total from sgm_clients where visible=1 and impacto=1 and id_origen=0";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$rowxt = mysql_fetch_array($resultxt);
			echo "<tr><td style=\"text-align:left\">Total contactos impactos (sin delegaciones)</td><td style=\"text-align:center\">".$rowxt["total"]."</td></tr>";
			...
			echo "<tr><td style=\"text-align:left\"><strong>Total contactos personales</strong></td><td style=\"text-align:center\"><strong>".$rowxt["total"]."</strong></td></tr>";
						...
						$sqlxt = "select * from sgm_clients where visible=1 and cliente=1";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$total = 0;
						while ($rowxt = mysql_fetch_array($resultxt)) {
							$sqlxt1 = "select count(*) as total from sgm_clients_contactos where visible=1 and id_client=".$rowxt["id"];
							$resultxt1 = mysql_query(convert_sql($sqlxt1));
							$rowxt1 = mysql_fetch_array($resultxt1);
							$total = $total + $rowxt1["total"];
						}
			echo "<tr><td style=\"text-align:left\">Total contactos personales clientes</td><td style=\"text-align:center\">".$total."</td></tr>";

						$sqlxt = "select * from sgm_clients where visible=1 and proveedor=1";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$total = 0;
						while ($rowxt = mysql_fetch_array($resultxt)) {
							$sqlxt1 = "select count(*) as total from sgm_clients_contactos where visible=1 and id_client=".$rowxt["id"];
			...
			echo "<tr><td style=\"text-align:left\">Total contactos personales proveedores</td><td style=\"text-align:center\">".$total."</td></tr>";

						$sqlxt = "select * from sgm_clients where visible=1 and impacto=1";
						$resultxt = mysql_query(convert_sql($sqlxt));
						$total = 0;
						while ($rowxt = mysql_fetch_array($resultxt)) {
							$sqlxt1 = "select count(*) as total from sgm_clients_contactos where visible=1 and id_client=".$rowxt["id"];
			...
			echo "<tr><td style=\"text-align:left\">Total contactos personales impactos</td><td style=\"text-align:center\">".$total."</td></tr>";
		echo "</table>";
		echo "<center>";
	}

	if ($soption == 400) {
		echo "<strong>Listados</strong>";
		echo "<br><br>";
		echo "<center>";
		echo "<table cellspacing=\"0\">";
			echo "<tr style=\"background-color: Silver;\">";
				echo "<td></td>";
				echo "<td style=\"text-align:center;width:200px\"><em>Contacto</em></td>";
				echo "<td></td>";
				echo "<td style=\"text-align:center;width:200px\"><em>Tipo</em></td>";
			echo "</tr>";
			echo "<form action=\"index.php?op=1008&sop=401\" method=\"post\">";
			echo "<tr>";
				echo "<td><input type=\"Checkbox\" name=\"cliente\" value=\"1\"></td>";
				echo "<td style=\"text-align:left\">Cliente</td>";
				$sqlc = "select * from sgm_clients_tipo_cliente order by tipo_cliente";
				$resultc = mysql_query(convert_sql($sqlc));
				$x = 1;
				while ($rowc = mysql_fetch_array($resultc)) {
					echo "<tr><td></td><td></td><td><input type=\"Checkbox\" name=\"c".$x."\" value=\"1\"></td><td>".$rowc["tipo_cliente"]."</td></tr>";
					$x++;
				}
			echo "</tr><tr>";
				echo "<td><input type=\"Checkbox\" name=\"proveedor\" value=\"1\"></td>";
				echo "<td style=\"text-align:left\">Proveedor</td>";
				$sqlp = "select * from sgm_clients_tipo_proveedor order by tipo_proveedor";
				$resultp = mysql_query(convert_sql($sqlp));
				$x = 1;
				while ($rowp = mysql_fetch_array($resultp)) {
					echo "<tr><td></td><td></td><td><input type=\"Checkbox\" name=\"p".$x."\" value=\"1\"></td><td>".$rowp["tipo_proveedor"]."</td></tr>";
					$x++;
				}
			echo "</tr><tr>";
				echo "<td><input type=\"Checkbox\" name=\"impacto\" value=\"1\"></td>";
				echo "<td style=\"text-align:left\">Impacto</td>";
				$sqli = "select * from sgm_clients_tipo_impacto order by tipo_impacto";
				$resulti = mysql_query(convert_sql($sqli));
				$x = 1;
				while ($rowi = mysql_fetch_array($resulti)) {
					echo "<tr><td></td><td></td><td><input type=\"Checkbox\" name=\"i".$x."\" value=\"1\"></td><td>".$rowi["tipo_impacto"]."</td></tr>";
					$x++;
				}
			echo "</tr><tr>";
				echo "<td></td><td><input type=\"submit\" value=\"Listar\" style=\"width:100px\"></td>";
			echo "</tr>";
			echo "</form>";
		echo "</table>";
		echo "</center>";
	...
	if ($soption == 401) {
		...
		echo "<table cellspacing=\"0\">";
			echo "<tr style=\"background-color: Silver;\">";
			echo "<td style=\"width:40px;text-align:center;\"><em>num</em></td>";
			echo "<td style=\"width:250px;text-align:center;\"><em>nombre</em></td>";
			echo "<td style=\"width:200px;text-align:center;\"><em>dirección</em></td>";
			echo "<td style=\"width:110px;text-align:center;\"><em>población</em></td>";
			echo "<td style=\"width:100px;text-align:center;\"><em>c. postal</em></td>";
			echo "<td style=\"width:100px;text-align:center;\"><em>provincia</em></td>";
			echo "<td style=\"width:100px;text-align:center;\"><em>teléfono</em></td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td>&nbsp;</td>";
				...
				echo "<td>&nbsp;</td>";
			echo "</tr>";
			$sql = "select * from sgm_clients";
			if ($_POST["cliente"] == 1) {
				$sql = $sql." where (cliente=1 ";
			}
			if (($_POST["proveedor"] == 1) and ($_POST["cliente"] == 1))  {
				$sql = $sql." or proveedor=1";
			} else {
				if ($_POST["proveedor"] == 1) {
					$sql = $sql." where (proveedor=1";
				}
			}
			if (($_POST["impacto"] == 1) and (($_POST["proveedor"] == 1) or ($_POST["cliente"] == 1))) {
				$sql = $sql." or impacto=1";
			} else {
				if ($_POST["impacto"] == 1) {
					$sql = $sql." where (impacto=1";
				}
			}
			$sqlc = "select * from sgm_clients_tipo_cliente order by tipo_cliente";
			$resultc = mysql_query(convert_sql($sqlc));
			...
			while ($rowc = mysql_fetch_array($resultc)) {
				if ($_POST["c".$x] == 1) {
					if ((($_POST["impacto"] == 1) or ($_POST["proveedor"] == 1) or ($_POST["cliente"] == 1)) or ($y > 1)){
						$sql = $sql." or";
					} else {
						$sql = $sql." where ("; 
					}
					$sql = $sql." id_tipo_cliente=".$rowc["id"];
					$y++;
				}
				$x++;
			}
			...
			while ($rowp = mysql_fetch_array($resultp)) {
				if ($_POST["p".$x] == 1) {
					if ((($_POST["impacto"] == 1) or ($_POST["proveedor"] == 1) or ($_POST["cliente"] == 1)) or (($y > 1) or ($z > 1))){
						$sql = $sql." or";
					} else {
						$sql = $sql." where (";
					} 
					$sql = $sql." id_tipo_proveedor=".$rowp["id"];
					$z++;
				}
				$x++;
			}
			...
			while ($rowi = mysql_fetch_array($resulti)) {
				if ($_POST["i".$x] == 1) {
					if ((($_POST["impacto"] == 1) or ($_POST["proveedor"] == 1) or ($_POST["cliente"] == 1)) or (($y > 1) or ($z > 1) or ($w > 1))){
						$sql = $sql." or";
					} else {
						$sql = $sql." where (";
					}  
					$sql = $sql." id_tipo_impacto=".$rowi["id"];
					$w++;
				}
				$x++;
			}
			$i = 1;
			$sql = $sql.") and visible=1 order by nombre";
			$result = mysql_query(convert_sql($sql));
			while ($row = mysql_fetch_array($result)) {
				echo "<tr>";
				echo "<td>".$i."</td>";
			...
			echo "<tr><td>&nbsp;</td></tr>";
			echo "<tr><td>&nbsp;</td></tr>";
			echo "<tr><td><a href=\"".$urloriginal."/mgestion/gestion-clientes-lista-print.php?&sql=".$sql."\" target=\"_blank\"><img src=\"mgestion/pics/icons-mini/printer.png\" style=\"border:0px;\"></a></td></tr>";
		echo "</table>";
		echo "</center>";
}
	...
	if ($soption == 500) {
		...
		echo "<table>";
			echo "<tr>";
				...
				echo "</td>";
				echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1008&sop=80\" style=\"color:white;\">Datos Adicionales</a>";
				echo "</td>";
				echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1008&sop=247\" style=\"color:white;\">Proveedores</a>";
				echo "</td>";
			echo "</tr>";
		echo "</table>";
		}
