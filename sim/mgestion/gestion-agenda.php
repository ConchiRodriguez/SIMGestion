...
if (($option == 1006) AND ($autorizado == true)) {
	...
	echo "<table style=\" border-bottom : 1px solid grey; border-left : 1px solid grey; border-right : 1px solid grey; border-top : 1px solid grey;text-align:center;width:100%\" cellpadding=\"2\" cellspacing=\"2\" ><tr>";
		echo "<td style=\"width:25%;vertical-align : top;text-align:left;\">";
			echo "<center><table><tr>";
				...
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=0&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Agenda."</a></td>";
				$color = "#4B53AF";
				$lcolor = "white";
				if ($soption == 10) { $color = "white"; $lcolor = "blue"; }
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=10&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Calendario."</a></td>";
				$color = "#4B53AF";
				$lcolor = "white";
				if (($soption == 20) and ($_GET["id"] == "")) { $color = "white"; $lcolor = "blue"; }
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=20&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Nueva." ".$Tarea."</a></td>";
				$color = "#4B53AF";
				$lcolor = "white";
				if ($soption == 30) { $color = "white"; $lcolor = "blue"; }
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=30&dd=".$dia."&aa=".$any."&mm=".$mes."&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Imprimir."</a></td>";
				$color = "#4B53AF";
				$lcolor = "white";
				if ($soption == 200) { $color = "white"; $lcolor = "blue"; }
				echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=200&dd=".$_GET["dd"]."&aa=".$_GET["aa"]."&mm=".$_GET["mm"]."&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Sincronizar."</a></td>";
				if ($admin == true) {
					$color = "#4B53AF";
					$lcolor = "white";
					if ($soption == 40) { $color = "white"; $lcolor = "blue"; }
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=40&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Administrar."</a></td>";
				}
				...
				if ($soption == 0){
					...
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=0&ssop=4&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Completa."</a></td>";
					$color = "#4B53AF";
					$lcolor = "white";
					if ($ssoption == 3) { $color = "white"; $lcolor = "blue"; }
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=0&ssop=3&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Historico."</a></td>";
					$color = "#4B53AF";
					$lcolor = "white";
					if ($ssoption == 5) { $color = "white"; $lcolor = "blue"; }
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=0&ssop=5&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Sin." ".$Agenda."</a></td>";
					$color = "#4B53AF";
					$lcolor = "white";
				}
				if ($soption == 30){
					...
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=30&ssop=0&usuario=".$userid."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" class=\"gris\" style=\"color:".$lcolor."\">".$Jornada."</a></td>";
					$color = "#4B53AF";
					$lcolor = "white";
					if ($ssoption == 1) { $color = "white"; $lcolor = "blue"; }
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=30&ssop=1&usuario=".$userid."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" class=\"gris\" style=\"color:".$lcolor."\">".$Semana."</a></td>";
					$color = "#4B53AF";
					$lcolor = "white";
					if ($ssoption == 2) { $color = "white"; $lcolor = "blue"; }
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=30&ssop=2&usuario=".$userid."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" class=\"gris\" style=\"color:".$lcolor."\">".$Mes."</a></td>";
#					$color = "#4B53AF";
#					$lcolor = "white";
#					if ($ssoption == 3) { $color = "white"; $lcolor = "blue"; }
#					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=30&ssop=3&usuario=".$userid."&dia=".$dia."&mes=".$mes."&any=".$any."\" class=\"gris\" style=\"color:".$lcolor."\">Todas</a></td>";
				}
				if ($soption == 20){
					echo "</tr><tr><td></td>";
					$color = "#4B53AF";
					...
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=20&inc=0&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Tarea."</a></td>";
					$color = "#4B53AF";
					$lcolor = "white";
					if ($_GET["inc"] == 1) { $color = "white"; $lcolor = "blue"; }
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=20&inc=1&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Telefonica."</a></td>";
					$color = "#4B53AF";
					$lcolor = "white";
					if ($_GET["inc"] == 2) { $color = "white"; $lcolor = "blue"; }
					echo "<td style=\"height:20px;width:120px;text-align:center;vertical-align:middle;background-color:".$color.";border: 1px solid black\"><a href=\"index.php?op=1006&sop=20&inc=2&usuario=".$userid."\" class=\"gris\" style=\"color:".$lcolor."\">".$Nota."</a></td>";
				}
...
if (($soption == 0) and ($ssoption <= 2)) {
	...
	echo "<table style=\"width:100%\" cellpadding=\"2\" cellspacing=\"2\" >";
		echo "<tr>";
			echo "<td style=\"width:120px;vertical-align : top;text-align:left;\">";
				...
				echo "</table>";
			echo "</td><td>";
				echo "<form name=\"formulari\" action=\"index.php?op=1006&sop=0&usuario=".$usuario."\" method=\"post\">";
				echo "<table cellspacing=\"20\">";
					echo "<tr><td><strong>".$Seleccionar." ".$agendas." (max. de 2) :</strong></td></tr>";
					echo "<tr>";
						echo "<td><table><tr>";
	...
	echo "</table><table>";
		...
		if ($_POST["casilla1"] != ""){
			...
			$rowag = mysql_fetch_array($resultag);
				...
				########INICI INCIDENCIAS
				echo "<strong>".$Tareas."</strong> (del ".$diaa." ".$seleccionado.")";
	...
	if (($soption == 0) and (($ssoption == 3) or ($ssoption == 4) or ($ssoption == 5))) {
		if ($ssoption == 4) {
			echo "<strong>".$AGENDA." : ".$username."</strong>";
			echo "<form action=\"index.php?op=1006&sop=0&ssop=4\" method=\"post\">";
		}
		if ($ssoption == 3) {
			echo "<strong>".$HISTORICO." : </strong>";
			echo "<form action=\"index.php?op=1006&sop=0&ssop=3\" method=\"post\">";
		}
		if ($ssoption == 5) {
			echo "<strong>".$SIN." ".$AGENDA." : </strong>";
			echo "<form action=\"index.php?op=1006&sop=0&ssop=5\" method=\"post\">";
		}
		echo "<br><br>";
		echo "<center><table cellspacing=\"0\">";
			...
			echo "<tr>";
				...
				echo "<td><select name=\"servicio\" style=\"width:150px;\">";
				...
				echo "<td><select name=\"cliente\" style=\"width:400px;\">";
					echo "<option value=\"0\">-</option>";
				...
				echo "<td><select name=\"estado\" style=\"width:150px;\">";
					if ($ssoption == 4) {
						echo "<option value=\"0\">-</option>";
				...
				echo "<td><select name=\"departamento\" style=\"width:150px;\">";
					echo "<option value=\"0\">-</option>";
				...
				echo "</select></td>";
				echo "<td>";
					echo "<select name=\"agenda\" style=\"width:100px;\">";
						echo "<option value=\"0\">-</option>";
						$sql = "select * from sgm_agendas where visible=1";
						$result = mysql_query(convertSQL($sql));
						while ($row = mysql_fetch_array($result)) {	
							if ($_POST["agenda"] == $row["id"]) {
								echo "<option value=\"".$row["id"]."\" selected>".$row["nombre"]."</option>";
							} else {
								echo "<option value=\"".$row["id"]."\">".$row["nombre"]."</option>";
							}
			...
			if (($_POST["departamento"] != "") and ($_POST["departamento"] != 0)) { $sql = $sql." and id_departamento = ".$_POST["departamento"].""; }
			if (($_POST["estado"] != "") and ($_POST["estado"] != 0)) { $sql = $sql." and id_estado = ".$_POST["estado"]."";}
			if (($_POST["cliente"] != "") and ($_POST["cliente"] != 0)) { $sql = $sql." and id_cliente = ".$_POST["cliente"].""; }
			if (($_POST["servicio"] != "") and ($_POST["servicio"] != 0)) { $sql = $sql." and id_servicio = ".$_POST["servicio"].""; }
			if (($_POST["agenda"] != "") and ($_POST["agenda"] != 0)) {	$sql = $sql." and id_agenda=".$_POST["agenda"];	}
			$date = getdate(); 
			$fecha = $date["year"]."-".$date["mon"]."-".$date["mday"];

			if ($ssoption == 5) {
				$sql = $sql." and (id_estado <> -2) and ((id_agenda = 0) or (id_agenda = NULL))";
			}
			if ($ssoption == 4) {
				$sql = $sql." and (id_estado <> -2) and id_agenda <> 0";
			}

			if ($ssoption == 3) { $sql = $sql." and id_estado = -2"; }

			$sql = $sql." and privada=1 order by ";
			if ($_POST["orden"] == 1) { $sql = $sql." id_estado,"; }
			if ($_POST["orden"] == 2) { $sql = $sql." id_departamento,"; }
			if ($_POST["orden"] == 3) { $sql = $sql." id_usuario_destino,"; }
			if ($_POST["orden"] == 4) { $sql = $sql." id_cliente,"; }
#			if (($_POST["orden"] == 5) OR ($_POST["orden"] == "")) { $sql = $sql." data_prevision,"; }
			if ($_POST["orden"] == 6) { $sql = $sql." id_servicio,"; }
			if (($ssoption == 4) or ($ssoption == 5)) { $sql = $sql."data_prevision"; }
			if ($ssoption == 3) { $sql = $sql."data_prevision DESC"; }
#			$sql = $sql. " limit ".$inicio.", ".$lineas_por_pagina;
			$result = mysql_query(convertSQL($sql));
			while ($row = mysql_fetch_array($result)) {

				$ver_tarea = true;
				if ($_GET["id_grupo"] != "") {
					$sqlg = "select * from sgm_incidencias_tipos where id=".$row["id_tipo"];
					$resultg = mysql_query(convertSQL($sqlg));
					$rowg = mysql_fetch_array($resultg);
					if ($rowg["id_tipo_grupo"] != $_GET["id_grupo"]) {
						$ver_tarea = false;
					}
				}

				$sqlag = "select count(*) as total from sgm_agendas_users where id_agenda=".$row["id_agenda"]." and id_user=".$userid;
				$resultag = mysql_query(convertSQL($sqlag));
				$rowag = mysql_fetch_array($resultag);
				if (($rowag["total"] <= 0) and ($row["id_agenda"] != 0)){$ver_tarea = false;}
				...
				$sqlu = "select * from sgm_agendas where id=".$row["id_agenda"];
				...
				echo "<tr style=\"background-color:".$estado_color.";\">";
					...
					echo "<td style=\"color:".$estado_color_letras.";vertical-align:top;\">";
					if (strlen($rowu["nombre"]) > 15) {
						 echo "&nbsp;&nbsp;".substr($rowu["nombre"],0,11)." ...";
					} else {
						echo "&nbsp;&nbsp;".$rowu["nombre"]."";
					}
					echo "</td>";
					echo "<td style=\"text-align:center;vertical-align:top;\">";
						echo "<a href=\"index.php?op=1006&sop=20&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_add.png\" style=\"border:0px;\"><a>";
						echo "&nbsp;";
						echo "<a href=\"".$urloriginal."/mgestion/gestion-incidencia-print.php?id=".$row["id"]."\" target=\"_blank\"><img src=\"mgestion/pics/icons-mini/printer.png\" style=\"border:0px;\"></a>";
					echo "</td>";
					echo "<td style=\"text-align:center;vertical-align:top;\">";
						echo "<form action=\"index.php?op=1006&sop=1&id=".$row["id"]."\" method=\"post\">";
						if (($ssoption == 4) or ($ssoption == 5)) { echo "<select name=\"id_origen\" style=\"width:50px;\">"; }
						if ($ssoption == 3) { echo "<select name=\"id_origen\" style=\"width:50px;\" disabled>"; }

							echo "<option value=\"0\" selected>-</option>";

						if (($ssoption == 4) or ($ssoption == 5)) { $sqlin = "select * from sgm_incidencias where id<>".$row["id"]." and id_usuario_destino=".$row["id_usuario_destino"]." and id_estado<>-2 and visible=1 "; }
						if ($ssoption == 3) { $sqlin = "select * from sgm_incidencias where id<>".$row["id"]." and id_usuario_destino=".$row["id_usuario_destino"]." and visible=1 "; }
						...
						echo "</select>";
						if (($ssoption == 4) or ($ssoption == 5)) { echo "<input type=\"Submit\" value=\"R\">"; }
						echo "</form>";
					echo "</td>";
				}
			echo "</tr>";
	...
	if ($soption == 10) {
		echo "<table>";
			echo "<tr>";
				echo "<td style=\"text-align:center;vertical-align:top;\">";
					echo "<form name=\"formulari\" action=\"index.php?op=1006&sop=10&usuario=".$usuario."&dd=".$_GET["dd"]."&aa=".$_GET["aa"]."&mm=".$_GET["mm"]."\" method=\"post\">";
	...
	if ($soption == 20) {
		if ($ssoption == 1) {
			...
			if (($rowi["id_agenda"] != $_POST["id_agenda"]) and ($_POST["id_agenda"] != 0)){
				$sql = "insert into sgm_incidencias_canvio_usuario (id_incidencia, id_agenda_origen, fecha, motivo) ";
				$sql = $sql."values (";
				$sql = $sql.$_GET["id"];
			...
			if ($_POST["notas_desarrollo"] != ""){
				$sql = "insert into sgm_incidencias_notas_desarrollo (id_incidencia, id_agenda_origen, fecha, notas) ";
				$sql = $sql."values (";
				$sql = $sql.$_GET["id"];
				$sql = $sql.",".$rowi["id_agenda"];
				$a = date("Y");
			...
			$sql = $sql.",data_prevision='".$_POST["data_prevision"]."'";
...
#			$sql = $sql.",aviso=".$_POST["aviso"]."";
			...
			$sql = $sql.",cliente_nombre='".comillas($_POST["cliente_nombre"])."'";
			$sql = $sql.",cliente_contacto='".comillas($_POST["cliente_contacto"])."'";
		...
		if ($_GET["inc"] == 0) {echo "<strong>".$Edicion." de ".$Tarea.":</strong>";}
		if ($_GET["inc"] == 1) {echo "<strong>".$Edicion." de ".$Tarea." ".$Telefonica.":</strong>";}
		if ($_GET["inc"] == 2) {echo "<strong>".$Edicion." de ".$Nota.":</strong>";}
		$editando = false;
		...
		if ($_GET["id"] == ""){
			echo "<form action=\"index.php?op=1006&sop=21\" method=\"post\">";
			$fecha_prevision = date("Y-m-d", mktime(0,0,0,$m ,$d, $a))." ".date("H:i");
			if ($_POST["data_prevision"] != "") { $fecha_prevision = $_POST["data_prevision"]; }
			$fecha_margen = date("Y-m-d", mktime(0,0,0,$m ,$d, $a))." ".date("H:i");
			if ($_POST["data_prevision"] != "") { $fecha_margen = $_POST["data_prevision"]; }
			...
			$result = mysql_query(convertSQL($sql));
			$row = mysql_fetch_array($result);
			$fecha_prevision = $row["data_prevision"];
			...
			echo "<form action=\"index.php?op=1006&sop=20&ssop=1&id=".$row["id"]."\" method=\"post\">";
			$editando = true;
		...
		if ($usuario_con_permiso == true) {
			echo " <a href=\"index.php?op=1006&sop=24&id=".$_GET["id"]."&usuario=".$_GET["usuario"]."\">[ ".$Eliminar." ".$Tarea." ]</a>";
		}
		...
		if ($_GET["inc"] != 2){
			...
			echo "<tr style=\"background-color : Silver;\"><td style=\"text-align:right;vertical-align:top;\"></td><td><input type=\"Text\" name=\"cliente_nombre\" value=\"".$row["cliente_nombre"]."\" class=\"px300\"></td></tr>";
			...
			echo "<tr><td style=\"text-align:right;vertical-align:top;\">".$Servicio." :</td><td><select name=\"id_servicio\" class=\"px300\">";
				echo "<option value=\"0\" selected>-</option>";
					$sqlc = "select * from sgm_incidencias_servicios where visible=1 order by servicio";
					$resultc = mysql_query(convertSQL($sqlc));
					while ($rowc = mysql_fetch_array($resultc)) {
						if ($rowc["id"] == $servicio) {
...
#						echo busca_servicios($rowc["id"],$rowc["servicio"],$servicio);
			...
			echo "<tr><td style=\"text-align:right;vertical-align:top;\">".$Tipo." :</td><td><select name=\"id_tipo\" class=\"px300\">";
				echo "<option value=\"0\" selected>-</option>";
				$sqlt = "select * from sgm_incidencias_tipos_grupo where visible=1";
				$resultt = mysql_query(convertSQL($sqlt));
				while ($rowt = mysql_fetch_array($resultt)) {
					$sqltg = "select count(*) as total from sgm_incidencias_tipos where visible=1 and id_tipo_grupo=".$rowt["id"];
					$resulttg = mysql_query(convertSQL($sqltg));
					$rowtg = mysql_fetch_array($resulttg);
					if ($rowtg["total"] > 0){
						$sqltt = "select * from sgm_incidencias_tipos where visible=1 and id_tipo_grupo=".$rowt["id"];
			...
			echo "<option value=\"0\" selected>-</option>";
				$sqld = "select * from sgm_incidencias_departamento where visible=1 order by nombre";
				$resultd = mysql_query(convertSQL($sqld));
			...
			echo "<tr style=\"background-color : Silver;\"><td></td><td>";
					$sqlc = "select * from sgm_incidencias_canvio_usuario where id_incidencia=".$_GET["id"]." order by fecha";
					$resultc = mysql_query(convertSQL($sqlc));
					while ($rowc = mysql_fetch_array($resultc)) {
		...
		$sqlau = "select * from sgm_agendas_users where propietario=1 and id_user=".$_GET["usuario"];
		$resultau = mysql_query(convertSQL($sqlau));
		$rowau = mysql_fetch_array($resultau);
		echo "<tr style=\"background-color : Silver;\"><td style=\"text-align:right;vertical-align:top;\">".$Agenda.$row["id_agenda"]." :</td><td><select name=\"id_agenda\" class=\"px300\">";
		echo "<option value=\"0\" selected>-</option>";

			$sqlu = "select * from sgm_agendas where visible=1";
			$resultu = mysql_query(convertSQL($sqlu));
			while ($rowu = mysql_fetch_array($resultu)) {
				if ($rowu["id"] == $row["id_agenda"] ) {
					echo "<option value=\"".$rowu["id"]."\" selected>".$rowu["nombre"]."</option>";
				} else {
					if ((!($row["id_agenda"] != "")) && ($rowau["id_agenda"] == $rowu["id"])){
						echo "<option value=\"".$rowu["id"]."\" selected>".$rowu["nombre"]."</option>";
					} else {
		...
		if ($editando == true) {
		echo "<tr><td style=\"text-align:right;vertical-align:top;\">".$Motivo." ".$Cambio." :</td><td><textarea name=\"motivo\" class=\"px300\" rows=\"2\"></textarea></td></tr>";
		}
		...
		echo "</td><td><select name=\"id_estado\" class=\"px200\">";
			...
			$sqls = "select * from sgm_incidencias_estados where visible=1 order by estado";
		...
		if ($_GET["inc"] != 2){
			echo "<tr><td style=\"text-align:right;\">".$Fecha." ".$Prevision." :</td>";
				echo "<td><table><tr><td><input type=\"Text\" name=\"data_prevision\" value=\"".$fecha_prevision."\" style=\"width:150px;text-align:left;\"></td>";
				echo "<td style=\"width:70px;text-align:right;\">".$Duracion." : </td>";
			...
			echo "<tr><td style=\"text-align:right;vertical-align:top;\">".$Fecha." ".$Limite." ".$Prevision." :</td>";
				...
				echo "<td></td><td></td>";
##				echo "<td style=\"width:70px;text-align:right;\">".$Aviso." : </td>";
...
#				echo "</select></td>";
		...
		$sqlc = "select * from sgm_incidencias_notas_desarrollo where id_incidencia=".$_GET["id"]." order by fecha";
		$resultc = mysql_query(convertSQL($sqlc));
		while ($rowc = mysql_fetch_array($resultc)) {
			$sqlu = "select * from sgm_users where id=".$rowc["id_usuario_origen"];
			$resultu = mysql_query(convertSQL($sqlu));
		...
		if ($_GET["inc"] == 2){
			...
			echo "<input type=\"hidden\" value=\"0000-00-00 00:00:00\" name=\"data_prevision\">";
		...
		if (($_GET["inc"] != 2) and ($_GET["inc"] != 1)){
			echo "<td style=\"vertical-align: top\">";
				echo "<table cellpadding=\"1\" cellspacing=\"0\">";
					echo "<tr>";
						echo "<td style=\"text-align:right;width:150px;\"><strong>".$Plantillas." ".$Asociadas." :</strong></td>";
						echo "<td></td>";
					echo "</tr>";
					echo "<tr style=\"background-color : Silver;\">";
						echo "<td style=\"width:100px;text-align:center;\">".$Plantilla."</td>";
						echo "<td style=\"width:100px;text-align:center;color:black;\"></td>";
					echo "</tr>";
					$sql2 = "select * from sgm_incidencias_tipos_plantillas where id_incidencia_tipo=".$row["id_tipo"];
					...
					while ($row2 = mysql_fetch_array($result2)) {	
						...
						$sqlt = "select count(*) as total from sgm_ft where  id_plantilla=".$rowv["id"]." and id_incidencia=".$_GET["id"];
						$resultt = mysql_query(convertSQL($sqlt));
						$rowt = mysql_fetch_array($resultt);
						if ($rowt["total"] == 0) {
							echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1023&sop=210&id_incidencia=".$_GET["id"]."&id_plantilla=".$rowv["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white.png\" alt=\"Editar\" border=\"0\"> Añadir datos</a></td>";
						} else {
							$sqlft = "select * from sgm_ft where  id_plantilla=".$rowv["id"]." and id_incidencia=".$_GET["id"];
							$resultft = mysql_query(convertSQL($sqlft));
							$rowft = mysql_fetch_array($resultft);
							echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1023&sop=210&id_ft=".$rowft["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white.png\" alt=\"Editar\" border=\"0\">".$Editar."</a></td>";
						}
						echo "</tr>";
					}
				echo "</table>";
				...
				echo "<table cellpadding=\"1\" cellspacing=\"0\">";
					echo "<tr>";
						...
						if ($row["id_origen"] != 0) { echo "<a href=\"index.php?op=1006&sop=20&id=".$row["id_origen"]."\">&raquo; ".$Ver." ".$Tarea." ".$Anterior." nº ".$row["id_origen"]."</a>"; }
						echo "</td>";
					echo "</tr>";
					echo "<tr style=\"background-color : Silver;\">";
						echo "<td style=\"text-align:right;\"></td>";
		...
		if ($soption == 21) {
			$sql = "insert into sgm_incidencias (id_usuario,id_2,id_3,id_4,id_5,id_6,id_7,id_8,id_9,id_10,data_registro,id_cliente,id_servicio,data_insert,id_entrada,id_departamento,id_agenda,data_prevision,data_margen,tiempo,id_estado,id_tipo,notas_registro,notas_conclusion,programada,cliente_nombre,cliente_contacto,asunto,privada)";
			$sql = $sql."values (";
			$sql = $sql."".$userid."";
			...
			$sql = $sql.",'".$_POST["data_prevision"]."'";
			$sql = $sql.",'".comillas($_POST["data_margen"])."'";
			...
			$sql = $sql.",'".comillas($_POST["cliente_nombre"])."'";
			$sql = $sql.",'".comillas($_POST["cliente_contacto"])."'";
			$sql = $sql.",'".comillas($_POST["asunto"])."'";
			$sql = $sql.",".$_POST["privada"]."";
			$sql = $sql.")";
			mysql_query(convertSQL($sql));
			if ($_POST["notas_desarrollo"] != ""){
				$sqli = "select * from sgm_incidencias where asunto='".$_POST["asunto"]."' order by id DESC";
				$resulti = mysql_query(convertSQL($sqli));
				$rowi = mysql_fetch_array($resulti);
				$sql = "insert into sgm_incidencias_notas_desarrollo (id_incidencia, id_usuario_origen, fecha, notas) ";
				$sql = $sql."values (";
				$sql = $sql.$rowi["id"];
				$sql = $sql.",".$userid;
				$a = date("Y");
			...
			echo "<br><br><a href=\"index.php?op=1006&sop=0\">[ Volver ]</a>";	
		}

	if ($soption == 22){
		echo "<br><br>¿Desea eliminar la relación entre esta incidencia/tarea seleccionada?";
		echo "<br><br><a href=\"index.php?op=1006&sop=20&ssop=6&id=".$_GET["id"]."&id_tarea=".$_GET["id_tarea"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=20&id=".$_GET["id"]."\">[ NO ]</a>";
	}

	if ($soption == 24) {
		echo "<center><br><br>¿Desea eliminar la incidencia/tarea seleccionada?";
		echo "<br><br><a href=\"index.php?op=1006&sop=0&ssop=2&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=20&id=".$_GET["id"]."&usuario=".$_GET["usuario"]."\">[ NO ]</a></center>";
	}
	...
	if ($soption == 30){
		echo "<br><table>";
			...
			if ($ssoption == 0){
				...
				echo "<tr><td style=\"width:120px;text-align:left;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 15px;padding-left : 5px;\"><a href=\"".$urloriginal."/mgestion/gestion-incidencia-jornada-print.php?usuario=".$_GET["usuario"]."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" target=\"_blank\" style=\"color:white;\">Gráfico<br><img src=\"mgestion/pics/jor_graf.gif\" border=\"0\"></a></td>";
				echo "<td style=\"width:120px;text-align:left;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 15px;padding-left : 5px;\"><a href=\"".$urloriginal."/mgestion/gestion-incidencia-jornada-lista-print.php?usuario=".$_GET["usuario"]."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" target=\"_blank\" style=\"color:white;\">Lista<br><img src=\"mgestion/pics/mes_list.gif\" border=\"0\"></a></td></tr>";
			}
			if ($ssoption == 1){
				echo "<tr><strong>".$Imprimir." ".$Semana."</strong></tr>";
				echo "<tr><td style=\"width:120px;text-align:left;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 15px;padding-left : 5px;\"><a href=\"".$urloriginal."/mgestion/gestion-incidencia-setmana-print.php?usuario=".$_GET["usuario"]."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" target=\"_blank\" style=\"color:white;\">Gráfico<br><img src=\"mgestion/pics/sem_graf.gif\" border=\"0\"></a></td>";
				echo "<td style=\"width:120px;text-align:left;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 15px;padding-left : 5px;\"><a href=\"".$urloriginal."/mgestion/gestion-incidencia-setmana-lista-print.php?usuario=".$_GET["usuario"]."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" target=\"_blank\" style=\"color:white;\">Lista<br><img src=\"mgestion/pics/mes_list.gif\" border=\"0\"></a></td></tr>";
			}
			if ($ssoption == 2){
				echo "<tr><strong>".$Imprimir." ".$Mes."</strong></tr>";
				echo "<tr><td style=\"width:120px;text-align:left;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 15px;padding-left : 5px;\"><a href=\"".$urloriginal."/mgestion/gestion-incidencia-mes-print.php?usuario=".$_GET["usuario"]."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" target=\"_blank\" style=\"color:white;\">Gráfico<br><img src=\"mgestion/pics/mes_graf.gif\" border=\"0\"></a></td>";
				echo "<td style=\"width:120px;text-align:left;vertical-align:middle;background-color: #4B53AF;color: white;border: 1px solid black;height: 15px;padding-left : 5px;\"><a href=\"".$urloriginal."/mgestion/gestion-incidencia-mes-lista-print.php?usuario=".$_GET["usuario"]."&dd=".$_GET["dd"]."&mm=".$_GET["mm"]."&aa=".$_GET["aa"]."\" target=\"_blank\" style=\"color:white;\">Lista<br><img src=\"mgestion/pics/mes_list.gif\" border=\"0\"></a></td></tr>";
			}
			echo "</tr>";
			echo "</table></center>";
			echo "</td></tr>";
		...
		echo "<table>";
			echo "<tr>";
				echo "<td style=\"width:150px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1006&sop=120\" style=\"color:white;\">".$Agendas."</a>";
				echo "</td>";
				echo "<td style=\"width:150px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1006&sop=100\" style=\"color:white;\">".$Acceso." ".$Agendas."</a>";
				echo "</td>";
				echo "<td style=\"width:150px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1006&sop=50\" style=\"color:white;\">".$Departamentos."</a>";
				echo "</td>";
				echo "<td style=\"width:150px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1006&sop=60\" style=\"color:white;\">".$Estados."</a>";
				echo "</td>";
				echo "<td style=\"width:150px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1006&sop=70\" style=\"color:white;\">".$Tipos."</a>";
				echo "</td>";
				echo "<td style=\"width:150px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1006&sop=80\" style=\"color:white;\">".$Servicios."</a>";
				echo "</td>";
				echo "<td style=\"width:150px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
					echo "<a href=\"index.php?op=1006&sop=90\" style=\"color:white;\">".$Servicios." ".$Estados."</a>";
				echo "</td>";
		echo "</tr>";
		echo "</table>";
		}
	...
	if (($soption == 50) and ($admin == true)) {
		if (($ssoption == 1) and ($admin == true)) {	
			$sql = "insert into sgm_incidencias_departamento (nombre) ";
			$sql = $sql."values (";
		...
		if (($ssoption == 2) and ($admin == true)) {
			$sql = "update sgm_incidencias_departamento set ";
		...
		echo "<table><tr>";
			echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
				echo "<a href=\"index.php?op=1006&sop=40\" style=\"color:white;\">&laquo; ".$Volver."</a>";
			echo "</td>";
		echo "</tr></table>";
		echo "<center>";
		echo "<table cellpadding=\"1\" cellspacing=\"0\">";
		echo "<tr style=\"background-color:silver;\">";
			...
			echo "<td></td>";
		echo "</tr>";
			echo "<form action=\"index.php?op=1006&sop=50&ssop=1\" method=\"post\">";
			echo "<td></td>";
		...
		echo "<tr><td>&nbsp;</td></tr>";
			...
			while ($row = mysql_fetch_array($result)) {
				echo "<tr>";
#				echo "<td><a href=\"index.php?op=1006&sop=103&id=".$row["id"]."\">[E]</a></td>";
				echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=51&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
				echo "<form action=\"index.php?op=1006&sop=50&ssop=2&id=".$row["id"]."\" method=\"post\">";
	...
	if (($soption == 51) and ($admin == true)) {
		...
		echo "<br><br><a href=\"index.php?op=1006&sop=50&ssop=3&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=50\">[ NO ]</a></center>";
	}

	if (($soption == 60) and ($admin == true)) {
		if (($ssoption == 1) and ($admin == true)) {	
			$sql = "insert into sgm_incidencias_estados (estado,color) ";
			$sql = $sql."values (";
		...
		if (($ssoption == 2) and ($admin == true)) {
			$sql = "update sgm_incidencias_estados set ";
		...
		echo "</tr>";
			echo "<tr>";
				echo "<form action=\"index.php?op=1006&sop=60&ssop=1\" method=\"post\">";
				echo "<td></td>";
			...
			echo "</tr>";
				...
				while ($row = mysql_fetch_array($result)) {
					echo "<tr style=\"background-color:".$row["color"].";\">";
						echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=61&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
						echo "<form action=\"index.php?op=1006&sop=60&ssop=2&id=".$row["id"]."\" method=\"post\">";
		...
		echo "</table>";
			...
			echo "<br><br>* existe el estado <strong>REGISTRADA</strong>, que es la tarea que aun no se ha iniciado en ninguno de sus estados.";
			echo "<br><br>* existe el estado <strong>FINALIZADA</strong>, que hace referéncia a la finalización de la tarea.";
	...
	if (($soption == 61) and ($admin == true)) {
		...
		echo "<br><br><a href=\"index.php?op=1006&sop=60&ssop=3&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=60\">[ NO ]</a></center><br>";
	}

	if (($soption == 70) and ($admin == true)) {
		if (($ssoption == 1) and ($admin == true)) {	
			$sql = "insert into sgm_incidencias_tipos (tipo,id_tipo_grupo) ";
			$sql = $sql."values (";
			$sql = $sql."'".$_POST["tipo"]."'";
		...
		if (($ssoption == 2) and ($admin == true)) {
			$sql = "update sgm_incidencias_tipos set ";
		...
		if (($ssoption == 4) and ($admin == true)) {	
			$sql = "insert into sgm_incidencias_tipos_grupo (grupo) ";
			$sql = $sql."values (";
			$sql = $sql."'".$_POST["grupo"]."'";
			$sql = $sql.")";
			mysql_query(convertSQL($sql));
		...
		if (($ssoption == 5) and ($admin == true)) {
			$sql = "update sgm_incidencias_tipos_grupo set ";
		...
		echo "</tr>";
		echo "<tr>";
			echo "<form action=\"index.php?op=1006&sop=70&ssop=4\" method=\"post\">";
			echo "<td></td>";
		...
		echo "</tr>";
		echo "<tr><td>&nbsp;</td></tr>";
			$sql = "select * from sgm_incidencias_tipos_grupo where visible=1 order by grupo";
			$result = mysql_query(convertSQL($sql));
			while ($row = mysql_fetch_array($result)) {
				echo "<tr>";
				echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=72&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
				echo "<form action=\"index.php?op=1006&sop=70&ssop=5&id=".$row["id"]."\" method=\"post\">";
		...
		echo "</tr>";
		echo "<tr>";
			echo "<form action=\"index.php?op=1006&sop=70&ssop=1\" method=\"post\">";
			echo "<td></td>";
			echo "<td><select name=\"id_tipo_grupo\" style=\"width:150px;\">";
				echo "<option value=\"0\">-</option>";
				$sqlg = "select * from sgm_incidencias_tipos_grupo where visible=1 order by grupo";
				$resultg = mysql_query(convertSQL($sqlg));
		...
		echo "</tr>";
		echo "<tr><td>&nbsp;</td></tr>";
			$sql = "select * from sgm_incidencias_tipos where visible=1 order by tipo";
			$result = mysql_query(convertSQL($sql));
			while ($row = mysql_fetch_array($result)) {
				echo "<tr>";
				echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=71&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
				echo "<form action=\"index.php?op=1006&sop=70&ssop=2&id=".$row["id"]."\" method=\"post\">";
				echo "<td><select name=\"id_tipo_grupo\" style=\"width:150px;\">";
					echo "<option value=\"0\">-</option>";
					$sqlg = "select * from sgm_incidencias_tipos_grupo where visible=1 order by grupo";
					$resultg = mysql_query(convertSQL($sqlg));
				...
				echo "<td><input type=\"Submit\" value=\"".$Modificar."\" style=\"width:100px\"></td>";
				echo "</form>";
					$sqlxx = "select count(*) as total from sgm_incidencias_tipos_plantillas where id_incidencia_tipo=".$row["id"];
					$resultxx = mysql_query(convertSQL($sqlxx));
					$rowxx = mysql_fetch_array($resultxx);
				echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=75&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white.png\" alt=\"Plantillas\" border=\"0\"> ".$rowxx["total"]."</a></td>";
				echo "</tr>";
			}
		echo "</table>";
		echo "</center>";
	...
	if (($soption == 71) and ($admin == true)) {
		...
		echo "<br><br><a href=\"index.php?op=1006&sop=70&ssop=3&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=70\">[ NO ]</a></center><br>";
	}

	if (($soption == 72) and ($admin == true)) {
		echo "<center><br>¿Desea eliminar grupo de tipos de incidencias seleccionado?";
		echo "<br><br><a href=\"index.php?op=1006&sop=70&ssop=6&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=70\">[ NO ]</a></center><br>";
	}

	if (($soption == 75) and ($admin == true)) {
		if (($ssoption == 1) and ($admin == true)) {	
			$sql = "insert into sgm_incidencias_tipos_plantillas (id_incidencia_tipo,id_plantilla) ";
			$sql = $sql."values (";
			$sql = $sql."".$_GET["id"];
		...
		if (($ssoption == 2) and ($admin == true)) {
			$sql = "delete from sgm_incidencias_tipos_plantillas WHERE id=".$_GET["id_incidencia_tipo"];
			mysql_query(convertSQL($sql));
		}

		echo "<strong>".$Plantillas." del ".$Tipo." de ".$Tarea." : </strong>";
		echo "<br><br>";
		echo "<table><tr>";
			echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
				echo "<a href=\"index.php?op=1006&sop=70\" style=\"color:white;\">&laquo; ".$Volver."</a>";
			echo "</td>";
		echo "</tr></table>";
		$sqluuxx = "select * from sgm_incidencias_tipos where id=".$_GET["id"];
		...
		echo "<table cellpadding=\"1\" cellspacing=\"0\">";
			...
			echo "</tr>";
			echo "<tr>";
				echo "<form action=\"index.php?op=1006&sop=75&ssop=1&id=".$_GET["id"]."\" method=\"post\">";
				echo "<td></td>";
				echo "<td><select name=\"id_plantilla\" style=\"width:150px\">";
			...
			echo "</tr>";
			echo "<tr><td>&nbsp;</td></tr>";
			$sql2 = "select * from sgm_incidencias_tipos_plantillas where id_incidencia_tipo=".$_GET["id"];
			$result2 = mysql_query(convertSQL($sql2));
			while ($row2 = mysql_fetch_array($result2)) {	
				$sqlv = "select * from sgm_ft_plantilla where id=".$row2["id_plantilla"];
				$resultv = mysql_query(convertSQL($sqlv));
				$rowv = mysql_fetch_array($resultv);
				echo "<tr>";
					echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=76&id_incidencia_tipo=".$row2["id"]."&id=".$_GET["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
	...
	if (($soption == 76) and ($admin == true)) {
		echo "<br><br>¿Desea eliminar la relación seleccionada?";
		echo "<br><br><a href=\"index.php?op=1006&sop=75&ssop=2&id_incidencia_tipo=".$_GET["id_incidencia_tipo"]."&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=75&id=".$_GET["id"]."\">[ NO ]</a>";
	}
	...
	if (($soption == 80) and ($admin == true)) {
		...
		if (($ssoption == 1) and ($admin == true)) {	
			$sql = "insert into sgm_incidencias_servicios (servicio,codigo,id_origen) ";
			$sql = $sql."values (";
		...
		if (($ssoption == 2) and ($admin == true)) {
			$sql = "update sgm_incidencias_servicios set ";
		...
		if (($ssoption == 3) and ($admin == true)) {
			...
			$sql = $sql."visible=0";
			$sql = $sql." WHERE id_servicio=".$_GET["id"]."";
			mysql_query(convertSQL($sql));
		}
		...
		echo "</tr>";
		echo "<tr>";
			echo "<form action=\"index.php?op=1006&sop=80&ssop=1\" method=\"post\">";
			echo "<td></td>";
			echo "<td><select name=\"id_origen\" style=\"width:200px\">";
				echo "<option value=\"0\">-</option>";
				$sqlser = "select * from sgm_incidencias_servicios where visible=1 order by servicio";
				$resultser = mysql_query(convertSQL($sqlser));
		...
		echo "<tr style=\"background-color:silver;\">";
			...
			echo "<td></td>";
		echo "</tr>";
			$sql = "select * from sgm_incidencias_servicios where visible=1 order by codigo";
			$result = mysql_query(convertSQL($sql));
			while ($row = mysql_fetch_array($result)) {
				$color = "white";
				echo "<tr>";
				echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=81&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
				echo "<form action=\"index.php?op=1006&sop=80&ssop=2&id=".$row["id"]."\" method=\"post\">";
				echo "<td><select name=\"id_origen\" style=\"width:200px\">";
					echo "<option value=\"0\">-</option>";
					$sqlser = "select * from sgm_incidencias_servicios where visible=1 order by servicio";
					$resultser = mysql_query(convertSQL($sqlser));
	...
	if (($soption == 81) and ($admin == true)) {
		...
		echo "<br><br><a href=\"index.php?op=1006&sop=80&ssop=3&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=80\">[ NO ]</a></center><br>";
	}

	if (($soption == 90) and ($admin == true)) {
		if (($ssoption == 1) and ($admin == true)) {	
			$sql = "insert into sgm_incidencias_servicios_estados (nombre) ";
			$sql = $sql."values (";
			$sql = $sql."'".$_POST["nombre"]."'";
			$sql = $sql.")";
			mysql_query(convertSQL($sql));
		...
		if (($ssoption == 2) and ($admin == true)) {
			$sql = "update sgm_incidencias_servicios_estados set ";
			$sql = $sql."nombre='".$_POST["nombre"]."'";
			$sql = $sql." WHERE id=".$_GET["id"]."";
			mysql_query(convertSQL($sql));
		}
		if (($ssoption == 3) and ($admin == true)) {
			...
			$sql = "update sgm_incidencias_servicios_cliente set ";
			$sql = $sql."visible=0";
			$sql = $sql." WHERE id_estado=".$_GET["id"]."";
			mysql_query(convertSQL($sql));
		}

		echo "<strong>".$Estados." de ".$Servicios."</strong>";
		echo "<br><br>";
		echo "<table><tr>";
			echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
				echo "<a href=\"index.php?op=1006&sop=40\" style=\"color:white;\">&laquo; ".$Volver."</a>";
		...
		echo "<tr style=\"background-color:silver;\">";
			...
			echo "<td></td>";
		echo "</tr>";
			echo "<form action=\"index.php?op=1006&sop=90&ssop=1\" method=\"post\">";
			echo "<td></td>";
			echo "<td><input type=\"Text\" name=\"nombre\" style=\"width:150px\"></td>";
			echo "<td><input type=\"Submit\" value=\"".$Anadir."\" style=\"width:100px\"></td>";
			echo "<td></td>";
		...
		echo "</tr>";
		echo "<tr><td>&nbsp;</td></tr>";
			$sql = "select * from sgm_incidencias_servicios_estados where visible=1";
			$result = mysql_query(convertSQL($sql));
			while ($row = mysql_fetch_array($result)) {
				echo "<tr>";
				echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=91&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
				echo "<form action=\"index.php?op=1006&sop=90&ssop=2&id=".$row["id"]."\" method=\"post\">";
				echo "<td><input type=\"Text\" name=\"nombre\" style=\"width:150px\" value=\"".$row["nombre"]."\"></td>";
				echo "<td><input type=\"Submit\" value=\"".$Modificar."\" style=\"width:100px\"></td>";
				echo "</form>";
				echo "</tr>";
	...
	if (($soption == 91) and ($admin == true)) {
		echo "<center><br>¿Desea eliminar el departamento seleccionado?";
		echo "<br><br><a href=\"index.php?op=1006&sop=90&ssop=3&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=90\">[ NO ]</a></center><br>";
	}
	...
	if (($soption == 100) and ($admin == true)) {
		...
		echo "<strong>".$Acceso." a ".$Agendas." : </strong>";
		echo "<br><br>";
		echo "<table><tr>";
			echo "<td style=\"width:100px;height:20px;text-align:center;vertical-align:middle;background-color:#4B53AF;border:1px solid black\">";
				echo "<a href=\"index.php?op=1006&sop=40\" style=\"color:white;\">&laquo; ".$Volver."</a>";
		...
		echo "<table cellspacing=\"0\">";
			echo "<tr>";
				echo "<td style=\"text-align:center;\"><em>".$Agenda."</em></td>";
				echo "<td style=\"text-align:center;\"><em>".$Eliminar."</em></td>";
				echo "<td style=\"text-align:center;\"><em>".$Usuario."</em></td>";
				echo "<td style=\"text-align:center;\"><em>".$Permiso."</em></td>";
			echo "</tr>";
			$sqlv = "select * from sgm_agendas where visible=1";
			$resultv = mysql_query(convertSQL($sqlv));
			while ($rowv = mysql_fetch_array($resultv)){
				echo "<tr style=\"background-color : Silver;\">";
					echo "<form action=\"index.php?op=1006&sop=100&ssop=1\" method=\"post\">";
				...
				echo "<tr style=\"background-color:".$color."\">";
						echo "<form action=\"index.php?op=1006&sop=100&ssop=2&id=".$row2["id"]."\" method=\"post\">";
						echo "<td></td>";
						echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=101&id=".$row2["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" style=\"border:0px;\"><a></td>";
					...
					echo "</form>";
					if ($row2["propietario"] == 0){
						echo "<form action=\"index.php?op=1006&sop=100&ssop=4&id=".$rowv["id"]."&user=".$rowu["id"]."\" method=\"post\">";
					} else {
						echo "<form action=\"index.php?op=1006&sop=100&ssop=5&id=".$row2["id"]."\" method=\"post\">";
					}
	...
	if (($soption == 101) and ($admin == true)) {
		...
		echo "<br><br><a href=\"index.php?op=1006&sop=100&ssop=3&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=100\">[ NO ]</a></center><br>";
	}
	...
	if (($soption == 120) and ($admin == true)) {
		...
		echo "<tr style=\"background-color:silver;\">";
			...
			echo "<td></td>";
		echo "</tr>";
			echo "<form action=\"index.php?op=1006&sop=120&ssop=1\" method=\"post\">";
			echo "<td></td>";
			echo "<td><input type=\"Text\" name=\"nombre\" style=\"width:150px\"></td>";
		...
		echo "<tr><td>&nbsp;</td></tr>";
			...
			while ($row = mysql_fetch_array($result)) {
				echo "<tr>";
				echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=121&id=".$row["id"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
				echo "<form action=\"index.php?op=1006&sop=120&ssop=2&id=".$row["id"]."\" method=\"post\">";
				echo "<td><input type=\"Text\" name=\"nombre\" style=\"width:150px\" value=\"".$row["nombre"]."\"></td>";
	...
	if (($soption == 121) and ($admin == true)) {
		...
		echo "<br><br><a href=\"index.php?op=1006&sop=120&ssop=3&id=".$_GET["id"]."\">[ SI ]</a>";
		echo "&nbsp;<a href=\"index.php?op=1006&sop=120\">[ NO ]</a></center><br>";
	}
	...
	if ($soption == 200) {
		...
		echo "<strong>".$Importar." ".$Tareas." :</strong>";
		echo "<center>";
		echo "<table cellpadding=\"1\" cellspacing=\"0\">";
			echo "<tr>";
				echo "<td style=\"width:200px;vertical-align:top;background-color:silver;\">";
					echo "<form enctype=\"multipart/form-data\" action=\"index.php?op=1006&sop=200&ssop=1000&usuario=".$_GET["usuario"]."\" method=\"post\">";
					echo "<center>";
						echo "<input type=\"hidden\" name=\"id_tipo\" value=\"4\">";
						echo "<input type=\"file\" name=\"archivo\" size=\"29px\">";
						echo "<br><br><input type=\"submit\" value=\"Enviar a la carpeta FILES/tares/\" style=\"width:200px\">";
					echo "</center>";
					echo "</form>";
				echo "</td>";
				echo "<td>&nbsp;</td>";
				echo "<td>";
					echo "Para importar tareas desde Outlook primero debemos crear un archivo<br> para exportarlo a esta aplicación. Para crear el archivo abriremos el<br> Outlook y clicaremos en 'Archivo'/'Importar y exportar'. Elegiremos la<br> opción 'Valores separados por tabulaciones(DOS). Después seguimos<br> hasta elegir el periodo de las tareas y el nombre del fichero que vamos a crear.";
				echo "</td>";
			echo "</tr>";
		echo "</table>";
		if ($archivo_name != ""){
			echo "<table>";
				echo "</tr>";
					...
					while (!feof($ar)){
						...
						if ($linea != ""){
							...
							if (($total >= 22) and ($x > 1)){
								...
								$sql = "select count(*) as total from sgm_incidencias where visible=1 and data_margen='".$data_finalit."' and asunto='".$asunto."' and data_prevision='".$data_insert."' and notas_registro=".$notas." and tiempo=".$time." and privada=".$privado;
								$result = mysql_query(convertSQL($sql));
								$row = mysql_fetch_array($result);
								if (($row["total"] == 0 ) and ($rowu["id"] > 0)){
									...
									while ($rowau = mysql_fetch_array($resultau)){
										$sqla = "insert into sgm_incidencias (asunto,data_prevision,data_margen,notas_registro,privada,id_agenda,id_estado,data_insert,id_2,id_3,id_4,id_5,id_6,id_7,id_8,id_9,id_10,tiempo) ";
					...
					$sqld = "insert into sgm_incidencias_reg (data_sincro) values ('".$fecha1."')";
		...
		echo "</center>";
		echo "<br><br><br>";
		echo "<strong>".$Exportar." ".$Tareas." :</strong>";
		echo "<center>";
		echo "<table cellpadding=\"0\" cellspacing=\"5\">";
			...
			echo "</tr><tr>";
				echo "<td style=\"vertical-align:top;\">";
					echo "<table cellpadding=\"0\" cellspacing=\"0\">";
						echo "<tr>";
							echo "<form action=\"index.php?op=1006&sop=200&usuario=".$_GET["usuario"]."\" method=\"post\">";
							echo "<center>";
								echo "<td><select name=\"dia1\" style=\"width:40px;\">";
									for ($i = 1; $i <= 31; $i++){
										if (($_POST["dia1"] == $i) or ($dia == $i)){
					...
					echo "<td style=\"vertical-align:top;\">";
						...
						echo "</table>";
				echo "</td>";
				echo "<td style=\"vertical-align:top;\"><input type=\"submit\" value=\"Crear .TXT\" style=\"width:100px\"></td>";
				echo "<td>&nbsp;</td>";
				echo "<td>";
					echo "Para exportar tareas desde esta aplicación<br> primero debemos crear un archivo para exportarlo<br> a Outlook. Solo debemos elegir el periodo de tareas<br> a exportar y crear el archivo. Para importar el archivo<br> abriremos el Outlook y clicaremos en 'Archivo'/'Importar<br> y exportar'. Elegiremos la opción 'Importar de otro<br> programa o archivo'. Después buscaremos el nombre<br> del fichero que hemos creado.";
				echo "</td>";
				echo "</center>";
				echo "</form>";
			echo "</tr>";
		...
		if (($_POST["dia1"] != "") and ($_POST["mes1"] != "") and ($_POST["año1"] != "")){
			...
			if (is_writable($nombre_archivo)) {
				...
				$sql = "select * from sgm_incidencias where visible=1 and data_prevision>'".$desde."' and data_prevision<'".$hasta."'";
				$result = mysql_query(convertSQL($sql));
				while ($row = mysql_fetch_array($result)){
					if ($row["notas_registro"] != "") { $notas = "\"".$row["notas_registro"]."\""; } else { $notas = ""; }
					$sqla = "select * from sgm_agendas_users where visible=1 and id_agenda=".$row["id_agenda"]." and propietario=1";
					$resulta = mysql_query(convertSQL($sqla));
					$rowa = mysql_fetch_array($resulta);
					$sqlu = "select * from sgm_users where validado=1 and activo=1 and id=".$rowa["id_user"]."";
					$resultu = mysql_query(convertSQL($sqlu));
					$rowu = mysql_fetch_array($resultu);
					if ($rowu["id"] == $userid){
						...
						$x = "";
						$fals = "Falso";
						list($data, $hora) = explode(" ", $row["data_prevision"]);
		...
		if ($ssoption == 1){
			$sqls = "select * from sgm_incidencias_reg where id=".$_GET["id"];
			$results = mysql_query(convertSQL($sqls));
			...
			$sql = "delete from sgm_incidencias_reg";
			$sql = $sql." WHERE id=".$_GET["id"]."";
			mysql_query(convertSQL($sql));
		}

		echo "<strong>".$Sincronizaciones." de ".$Tareas." :</strong>";
		echo "<center>";
		echo "<table cellpadding=\"1\" cellspacing=\"0\">";
		$x = 1;
		$sqls = "select * from sgm_incidencias_reg order by data_sincro desc";
		$results = mysql_query(convertSQL($sqls));
		while ($rows = mysql_fetch_array($results)) {
			if ($x <= 5){
				echo "<tr>";
				echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=200&ssop=1&id=".$rows["id"]."&usuario=".$_GET["usuario"]."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" alt=\"Eliminar\" border=\"0\"></a></td>";
...
function cerrable($id_incidencia)
{ 
	global $db;
	$volver = true;
	$sqlx = "select * from sgm_incidencias where id_origen=".$id_incidencia;
	$resultx = mysql_query(convertSQL($sqlx));
...
function relacionable($id_incidencia,$id_inici)
{ 
	global $db;
			$volver = false;
			$sqlx = "select * from sgm_incidencias where id=".$id_inici;
			$resultx = mysql_query(convertSQL($sqlx));
			$rowx = mysql_fetch_array($resultx);
			$id = $rowx["id"];
			$id_origen = $rowx["id_origen"];

			while (($id != $id_incidencia) and ($id_origen != 0)) {
				$sqlxx = "select * from sgm_incidencias where id=".$id_origen;
				$resultxx = mysql_query(convertSQL($sqlxx));
				$rowxx = mysql_fetch_array($resultxx);
				$id = $rowxx["id"];
				$id_origen = $rowxx["id_origen"];
			}
			if (($id_origen == 0) and ($id_incidencia != $id)) { $volver = true; } 
		...
		$rowau = mysql_fetch_array($resultau);
			...
			echo "<td style=\"vertical-align:top;width:350px;text\">";
				...
				echo "<div style=\"width:300px;height:500px;position:relative;left:0;top:0;z-index:1\">";
					echo "<table cellpadding=\"0\" cellspacing=\"0\">";
						...
						echo "<tr>";
							echo "<td>";
								...
								echo "<form action=\"index.php?op=1006&sop=20\" method=\"post\">";
									echo "<input type=\"Submit\" style=\"background-color : #4B53AF;color :white;width:25px;text-align:center\" value=\"&raquo;\">";
									echo "<input type=\"Hidden\" name=\"data_prevision\" value=\"".$any."-".$mes."-".$dia." ".$hora.":00\">";
					...
					$horafin = '23:59:59';
					$hoy2 = $any."-".$mes."-".$dia." ".$horafin;
					$sql = "select * from sgm_incidencias where visible=1 and tiempo > 0 and ((id_agenda=".$id.") or (id_2=".$id.") or (id_3=".$id.") or (id_4=".$id.") or (id_5=".$id.") or (id_6=".$id.") or (id_7=".$id.") or (id_8=".$id.") or (id_9=".$id."))";
					if ($rowau["propietario"] == 0) { $sql.=" and privada=1"; }
					$sql.= " order by data_prevision";
					$result = mysql_query(convertSQL($sql));
					while ($row = mysql_fetch_array($result)){
						if (($row["data_prevision"] >= $hoy1) and ($row["data_prevision"] <= $hoy2)){
							...
							echo "<div style=\"position:absolute;left:70;top:".($posicion).";z-index:2;width:200px;height:".(($row["tiempo"]*0.33333333333)-1)."px;background-color:".$estado_color.";color:".$estado_color_letras.";border:1px solid black\">";
								echo "<a href=\"index.php?op=1006&sop=20&id=".$row["id"]."\" style=\"color:".$estado_color_letras.";\">";
								if (strlen($rowc["nombre"]) > 15) { echo substr($rowc["nombre"],0,16); } else {	echo $rowc["nombre"]; }
								if ($row["asunto"] != "") {
									if (strlen($row["asunto"]) > 15) { $asunto = substr($row["asunto"],0,16); } else { $asunto = $row["asunto"]; }
									echo " - \"".$asunto."..\"";
								}
...
function mostrar_incidencia($tipus,$hoy1,$hoy2,$agenda1,$agenda2,$usuario)
{
	...
	for ($i = 0; $i < 2 ; $i++){
		...
		if ($tipus == 1){$sql = "select * from sgm_incidencias where ((data_prevision>'".$hoy1."') or (data_prevision='".$hoy1."')) and ((data_prevision<'".$hoy2."') or (data_prevision='".$hoy2."')) and visible=1 and ((id_agenda=".$agenda[$i].") or (id_2=".$agenda[$i].") or (id_3=".$agenda[$i].") or (id_4=".$agenda[$i].") or (id_5=".$agenda[$i].") or (id_6=".$agenda[$i].") or (id_7=".$agenda[$i].") or (id_8=".$agenda[$i].") or (id_9=".$agenda[$i].")) ".$ver_privada." order by data_prevision";}
		if ($tipus == 2){$sql = "select * from sgm_incidencias where ((data_prevision>'".$hoy2."') or (data_prevision='".$hoy2."')) and visible=1 and ((id_agenda=".$agenda[$i].") or (id_2=".$agenda[$i].") or (id_3=".$agenda[$i].") or (id_4=".$agenda[$i].") or (id_5=".$agenda[$i].") or (id_6=".$agenda[$i].") or (id_7=".$agenda[$i].") or (id_8=".$agenda[$i].") or (id_9=".$agenda[$i].")) ".$ver_privada." order by data_prevision";}
		if ($tipus == 3){$sql = "select * from sgm_incidencias where ((data_prevision<'".$hoy1."') or (data_prevision='".$hoy1."')) and data_prevision<>'1900-01-01 00:00:00' and id_estado<>-2  and id_origen=0 and visible=1 and ((id_agenda=".$agenda[$i].") or (id_2=".$agenda[$i].") or (id_3=".$agenda[$i].") or (id_4=".$agenda[$i].") or (id_5=".$agenda[$i].") or (id_6=".$agenda[$i].") or (id_7=".$agenda[$i].") or (id_8=".$agenda[$i].") or (id_9=".$agenda[$i].")) ".$ver_privada." order by data_prevision";}
		if ($tipus == 4){$sql = "select * from sgm_incidencias where id_estado<>-2 and ((data_prevision is NULL) or (data_prevision = '0000-00-00 00:00:00') or (data_prevision = '1900-01-01 00:00:00'))and id_origen=0 and id_cliente=0 and visible=1 and ((id_agenda=".$agenda[$i].") or (id_2=".$agenda[$i].") or (id_3=".$agenda[$i].") or (id_4=".$agenda[$i].") or (id_5=".$agenda[$i].") or (id_6=".$agenda[$i].") or (id_7=".$agenda[$i].") or (id_8=".$agenda[$i].") or (id_9=".$agenda[$i].")) ".$ver_privada." order by data_prevision";}
				$result = mysql_query(convertSQL($sql));
				while ($row = mysql_fetch_array($result)) {
					if ($row["id_estado"] > 0) {
						$sqle = "select * from sgm_incidencias_estados where id=".$row["id_estado"];
					...
					echo "<tr style=\"background-color:".$estado_color.";\">";
						...
						if (($rowti["total"] == 0) and ($rowu["escritura"] == 1)) {
							echo "<td style=\"text-align:center;vertical-align:top;\"><a href=\"index.php?op=1006&sop=24&id=".$row["id"]."&usuario=".$usuario."\"><img src=\"mgestion/pics/icons-mini/page_white_delete.png\" style=\"border:0px;\"><a></td>";
					...
					if ($tipus != 4){
						...
						echo "<td style=\"text-align:center;vertical-align:top;\">";
							$inc = 0;
							if ($row["data_prevision"] == '0000-00-00 00:00:00'){$inc = 2;}
							echo "<a href=\"index.php?op=1006&sop=20&id=".$row["id"]."&inc=".$inc."&usuario=".$usuario."\"><img src=\"mgestion/pics/icons-mini/page_white_add.png\" style=\"border:0px;\"><a>";
							echo "&nbsp;";
							echo "<a href=\"/demo/mgestion/gestion-incidencia-print.php?id=".$row["id"]."\" target=\"_blank\"><img src=\"mgestion/pics/icons-mini/printer.png\" style=\"border:0px;\"></a>";
						echo "</td>";
						echo "<td style=\"text-align:center;vertical-align:top;width:70px;\">";
							if ($rowu["escritura"] == 1) {
								echo "<form action=\"index.php?op=1006&sop=0&ssop=1&id=".$row["id"]."&usuario=".$usuario."\" method=\"post\">";
								echo "<select name=\"id_origen\" style=\"width:50px;\">";
									echo "<option value=\"0\" selected>-</option>";
									$sqlin = "select * from sgm_incidencias where id<>".$row["id"]." and id_agenda=".$row["id_agenda"]." and id_estado<>-2 and visible=1 ";
									$resultin = mysql_query(convertSQL($sqlin));
									while ($rowin = mysql_fetch_array($resultin)) {
									if (relacionable($row["id"],$rowin["id"])) {
										if ($rowin["id"] == $row["id_origen"]) {
...
function calendario_conjunto($dia_select,$year,$mes,$usuario,$ids_users) {
	...
	if ($m == 12) {
		...
		$mesok .= "<a href=\"index.php?op=1006&sop=10&dd=".$dia_select."&aa=".($eany)."&mm=".($emes)."&usuario=".$usuario."\" style=\"color:white;\">&laquo;&laquo;&nbsp;&nbsp;</a>";
		$mesok .= "<strong>".$mesesp."</strong> ".$year;
		$mesok .= "<a href=\"index.php?op=1006&sop=10&dd=".$dia_select."&aa=".($dany)."&mm=".($dmes)."&usuario=".$usuario."\" style=\"color:white;\">&nbsp;&nbsp;&raquo;&raquo;</a>";
		...
		while (($d < 32) and ($mes == $m)) {
			...
			$mesok .= "<a href=\"index.php?op=1006&dd=".$dformat."&aa=".($year)."&mm=".($mes)."&usuario=".$usuario."\" style=\"color:black;\">".$d."</a>";
				...
				for ($i = 0; $i < strlen($users) ; $i++){
					...
					$sql = "select * from sgm_incidencias where data_prevision>'".$a."-".$m."-".$dia." ".$horainici."' and data_prevision< '".$a."-".$m."-".$dia." ".$horafin."' and visible=1";
					$sql .= " and ((id_agenda=".$rowu["id_agenda"].") or(id_2=".$rowu["id_agenda"].") or(id_3=".$rowu["id_agenda"].") or(id_4=".$rowu["id_agenda"].") or(id_5=".$rowu["id_agenda"].") or(id_6=".$rowu["id_agenda"].") or(id_7=".$rowu["id_agenda"].") or(id_8=".$rowu["id_agenda"].") or(id_9=".$rowu["id_agenda"].") or(id_10=".$rowu["id_agenda"]."))";
					...
					while ($row = mysql_fetch_array($result)){
						if ($row["id_agenda"] )
							...
							$mesok .= "<tr><td><a href=\"index.php?op=1006&sop=20&id=".$row["id"]."\" style=\"color:".$estado_color_letras."\">".$hora.":".$minut." (".$row["tiempo"]." min.)</a></td></tr>";
...
{ 
	global $db;
			$sql = "select * from sgm_incidencias where visible=1 and id_origen=".$id;
			$result = mysql_query(convertSQL($sql));
			while ($row = mysql_fetch_array($result)){
				echo "<tr>";
					echo "<td style=\"text-align:center;\"><a href=\"index.php?op=1006&sop=22&id_tarea=".$row["id"]."&id=".$id."\"><img src=\"mgestion/pics/icons-mini/link_break.png\" alt=\"Desvincular\" border=\"0\"></a></td>";
					echo "<td style=\"width:100px;padding-left: ".$x."px;\"><a href=\"index.php?op=1006&sop=20&id=".$row["id"]."\">&raquo; Ver Tarea nº ".$row["id"]."</a></td>";
				echo "</tr>";
