...
CREATE TABLE `sgm_clients_busquedas` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
...
ALTER TABLE `sgm_clients_busquedas` ADD `origenes` varchar(50) NOT NULL default '' AFTER `sectors` ;
...
CREATE TABLE `sgm_clients_rel_origen` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
...
CREATE TABLE `sgm_clients_rel_sectores` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
...
CREATE TABLE `sgm_clients_rel_tipos` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
...
CREATE TABLE `sgm_clients_rel_ubicacion` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
...
CREATE TABLE `sim_comercial_articulos_grupos` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
ALTER TABLE `sim_comercial_articulos_grupos` ADD `id_articulo_grupo` int(11) NOT NULL default '0' AFTER `id`;

CREATE TABLE `sim_comercial_contenido` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
...
CREATE TABLE `sim_comercial_oferta_rel_servicios` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
...
CREATE TABLE `sim_control_versiones` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY  (`id`) );
...
ALTER TABLE `sgm_users_permisos_modulos_grupos` ADD `nombre_es` varchar(30) NOT NULL default '' AFTER `nombre`;
...
CREATE TABLE `sim_usuarios_tipos_departamentos` ( `id` int(11) NOT NULL auto_increment, PRIMARY KEY (`id`));
