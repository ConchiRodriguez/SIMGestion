...
if ($autorizado == true) {
		...
		echo "<td><textarea name=\"descripcion\" style=\"width:550px;height:125px\">".$row["descripcion"]."</textarea></td></tr></table>";
...
#				echo "<td></td>";
		...
		echo "<td><textarea name=\"aplicaciones_exteriores\" style=\"width:550px;height:60px\">".$row["aplicaciones_exteriores"]."</textarea></td></tr></table>";
		echo "<br>";
		...
		echo "<td><textarea name=\"observaciones\" style=\"width:550px;height:60px\">".$row["observaciones"]."</textarea></td></tr></table>";
		echo "<br>";
		...
		while ($rowf = mysql_fetch_array($resultf)) {
			...
			if ($x == 0) { echo "- <strong>".number_format($rowf["unidades"],2,',','.')."</strong> unidad/es de <strong>".$rowf["nombre"]."</strong>"; $x = 1; }
		}
