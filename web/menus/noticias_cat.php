...
echo "<table class=\"news\">";
	echo "<tr><td></td><td>".$NOTICIAS."</td></tr>";
		...
		echo "<br>";
		$sql = "select * from wp_posts where id in (select object_id from wp_term_relationships where term_taxonomy_id=5) and post_type='post' and post_status='publish' order by post_date desc LIMIT 0, 5";
	...
	echo "<tr><td></td><td><a href=\"index.php?mn=401&tax=5\">".$Leer_todas."</a></td></tr>";
	echo "<tr><td>&nbsp;</td></tr>";
