						...
						echo "<td class=\"cabezera_menu\">";
							echo "<table class=\"cabezera_menu\">";
								echo "<tr class=\"cabezera_menu\">";
									echo "<td style=\"text-align:left\"><strong>".$Contacto.": 93 522 26 27</strong></td>";
			...
			echo "<td>";
				echo "<table class=\"cabezera\">";
					echo "<tr class=\"cabezera\">";
						...
						if ($mn == 0) {
							echo "<a href=\"http://www.jornada.solucions-im.com/\"><img src=\"images/banners/inicio1.png\" alt=\"logo\" style=\"width:1000px;height:300px\"></a>";
						} else {
							echo "<a href=\"http://www.jornada.solucions-im.com/\"><img src=\"images/banners/inicio2.png\" alt=\"logo\" style=\"width:1000px;height:300px\"></a>";
						}
						echo "</td>";
					echo "</tr>";
				echo "</table>";
...
#							if ($_GET["mn"] == 600) {include("menus/presupuestos.php");}
							...
							if ($_GET["mn"] == 97){include("menus/lopd.html");}
						}
					if ($_GET["mn"] == 0){
						echo "<td class=\"cuerpo1\">";
							echo "<table class=\"news\">";
								echo "<tr><td></td><td>".$NOTICIAS."</td></tr>";
									...
									$sql = "select * from wp_posts where id in (select object_id from wp_term_relationships where term_taxonomy_id=".$tax.") and post_type='post' and post_status='publish' order by post_date desc limit 0, 15";
						...
						echo "</td>";
						echo "<td class=\"cuerpo2\">";
							echo "<a href=\"index.php?mn=120\"><img src=\"images/partners/op5-professional.jpg\" alt=\"logo\"></a><br><br>";
...
#								echo "<tr><td><a href=\"index.php?mn=240\" class=\"footer\">".$Otros." ".$Servicios."</a></td></tr>";
						...
						echo "<td style=\"width:250px;vertical-align:top;\">";
							echo "<table style=\"width:200px;\" class=\"footer\">";
								...
								echo "<tr><td><strong>93 522 26 27</strong></td></tr>";
