...
if ($accesolocal == true) { include ("../archivos_comunes/config3.php"); }
if ($accesolocal == false) { include ("../archivos_comunes/config4.php"); }
...
##			if ($option == 0) {
	...
	echo "</tr><tr>";
		...
		echo "</td>";
	echo "</tr><tr>";
		echo "<td style=\"text-align:center;\">".$Horario." ".$Atencion." ".$Cliente." : <strong>9</strong> a <strong>17</strong> de <strong>".$Lunes."</strong> a <strong>".$Viernes."</strong>. ".$Telefono." : <strong>902 787 362</strong>";
	...
	echo "</tr><tr><td>&nbsp;</td></tr><tr>";
		echo "<td style=\"height:20px; width:1250; background-color:grey; \"><font style=\"color : white; padding-left : 5px;\">";
			echo "<font style=\"color : white; padding-left : 5px;\">&copy;2013 Solucions-im.com</font>";
		echo "</font></td>";
	echo "</tr>";
echo "</table>";
